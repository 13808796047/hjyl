...
class JqPay
{
    ...
    protected static $merchantID = '505160'; //商户id
    protected static $url = 'https://user.ecpay.cn/';
   // protected static $url = 'http://user.sdecpay.com/';
    protected static $keyCode = '1elJtcfQZFroSiz20eHCRZmLGPVGLhoDLcn7x1K5wRJ1JulfHqXiOBkukygVOcwgtJ0ItRs0BVNHdt7RwQC33Y9UiUmIS9eEjUqUaYxfe3IHi73uH12RnSPPzmPEYgS2';

    public static function getParams ()
    {
        $notifyurl = 'http://'.$_SERVER['HTTP_HOST'].'/recharge/jq_callback';
        $data = $_REQUEST;
        ...
        //获得表单传过来的数据
        $def_url  = '<br />';
        $def_url  .= '<form id="ifrm" method="post" action="'.self::$url.'paygate.html"  >';
