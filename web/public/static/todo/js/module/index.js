!function() {
        function t() {
            this.show = function() {
                ...
                this.showButtonAndClose = function(t) {
                    var i = this;
                    $('<i class="close closeBtn close-notice"></i>').prependTo(".j-ui-miniwindow .hd"),
                        $('<button style="display: inline-block;" class="btn close-notice confirm">确 认</button>').appendTo(".j-ui-miniwindow"),
                        $("#notice-mask .close-notice").on("click",
                            function() {
                                t ? t() : i.hide()
                            })
                }
        ...
        $("input[focucmsg]").each(function() {
            $(this).val($(this).attr("focucmsg")),
                ...
                $(this).focus(function() {
                    $(this).val() == $(this).attr("focucmsg") && ($(this).val(""), $(this).val("").css("color", "#000"))
                }),
                $(this).blur(function() {
                    $(this).val() || ($(this).val($(this).attr("focucmsg")), $(this).val($(this).attr("focucmsg")).css("color", "#797979"))
                })
        });
        var i = function(t) {
                $(".login-status").text(message[t] || t).animate({
                        height: 50
                    },
                    300)
            },
        ...
        var n = function() {
            var t = $("#J-user-name"),
                s = $("#J-user-password"),
                n = $("#J-verification");
            return "" == $.trim(t.val()) ? (t.focus(), i(message["请填写用户名"]), !0) : "" == $.trim(s.val()) ? (s.focus(), i(message["请填写密码"]), !0) : "" == $.trim(n.val()) && (n.focus(), i(message["验证码不能为空"]), !0)
        };
        $("#J-form-submit").click(function(t) {
                ...
                function(o) {
                    ...
                    n() || (a = $.trim($("#J-verification").val()), $rq_post = {},
                        ...
                        n ?
                            ...
                            } (s.aLinks[0].url, n[1]) : "" == s.sMsg ? location.href = s.aLinks[0].url: (i(s.sMsg), setTimeout(function() {
            ...
            function() {
                $("#J-user-name, #J-user-password, #J-verification").on("input propertychange",
                    function() {
