!
    function() {
        var e = phoenix.Games;
        phoenix.Games.N115.getInstance(),
            ...
            phoenix.Games.N115.Message.getInstance(),
        ...
        var t = function(t) {
            ...
            e.getCurrentGame().addEvent("afterSwitchGameMethod",
                function() {
                    r ? (phoenix.Games.N115.getInstance().removeFakeBallDom(), r = !1, o.historyBall && setTimeout(function() {
                ...
                e.getCurrentGameTypes().addEvent("endChange",
                    function() {
                        a && (phoenix.Games.N115.getInstance().removeFakeMenuDom(), e.getCurrentGameTypes().containerShow(), a = !1)
                    }),
