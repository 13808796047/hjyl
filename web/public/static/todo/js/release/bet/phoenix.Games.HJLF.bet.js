!function() {
        var e = phoenix.Games;
        phoenix.Games.HJLF.getInstance(),
            ...
            phoenix.Games.HJLF.Message.getInstance(),
        ...
        var t = function(t) {
            ...
            e.getCurrentGame().addEvent("afterSwitchGameMethod",
                function() {
                    r ? (phoenix.Games.HJLF.getInstance().removeFakeBallDom(), r = !1, o.historyBall && setTimeout(function() {
                ...
                e.getCurrentGameTypes().addEvent("endChange",
                    function() {
                        a && (phoenix.Games.HJLF.getInstance().removeFakeMenuDom(), e.getCurrentGameTypes().containerShow(), a = !1)
                    }),
