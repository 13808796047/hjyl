!function() {
        ...
        var t = function(t) {
            ...
            e.getCurrentGame().addEvent("afterSwitchGameMethod",
                function() {
                    r ? (phoenix.Games.SSC.getInstance().removeFakeBallDom(), r = !1, o.historyBall && setTimeout(function() {
                ...
                e.getCurrentGameTypes().addEvent("endChange",
                    function() {
                        a && (phoenix.Games.SSC.getInstance().removeFakeMenuDom(), e.getCurrentGameTypes().containerShow(), a = !1)
                    }),
