        ...
        var r = {
            ...
            l = {
                ...
                makeSubmitParameter: function(t, e) {
                    for (var a = e.lotterys.slice(), i = 0; i < a.length; i++) a[i] = a[i].join("");
                    return a.join("&")
                },
                ...
                dragUpload: function() {
                    var t = this,
                        e = $(t.doc.body);
                    window.FileReader && (e.bind("dragover",
                        function(t) {
                            t.preventDefault(),
                                t.stopPropagation()
                        }), e.get(0).addEventListener("drop",
                        function(e) {
                            e.preventDefault(),
                                e.stopPropagation();
                            var a = e.dataTransfer.files,
                                ...
                                n = new FileReader,
                                r = i.type ? i.type: "n/a";
                            "text/plain" == r && (n.onload = function(e) {
                                var a = e.target.result;
                                "" != $.trim(a) && (t.replaceText(a), t.firstfocus = !1, t.updateData())
                            },
                                n.readAsText(i))
                        },
                        !1))
                ...
                checkSingleNum: function(t) {
                    var e = this;
                    return e.defConfig.checkNum.test(t) && t.length == e.balls.length
                },
                checkBallIsComplete: function(t) {
                    ...
                    if (e.isFirstAdd) for (e.aData = [], e.vData = [], e.sameData = [], e.errorData = [], e.tData = [], e.vDataBack = {},
                        ...
                        var n = i[a].split(""),
                            r = i[a];
                        e.checkSingleNum(r) ? (e.vDataBack[r] ? e.sameData.push(n) : e.tData.push(n), e.vDataBack[r] = n, e.vData.push(n)) : (e.errorDataBack[r] ? e.sameData.push(n) : e.errorData.push(n), e.errorDataBack[r] = n),
                ...
                checkFile: function(t, e) {
                    var a = t.value,
                        ...
                        i = i.toLowerCase();
                    return ".txt" != i ? (alert(translate.FileError), !1) : void e[0].submit()
                },
                getFile: function(t) {
                    var e = this,
                        a = e.container.find(e.defConfig.uploadButton);
                    t && (e.replaceText(t), e.firstfocus = !1, e.updateData(), a.blur().val(""))
                },
                ...
                sameDataTips: function() {
                    ...
                    if ("" != e.join("")) {
                        ...
                        a = '<h4 class="pop-text" style="display:block;"> ' + translate["以下号码重复，已进行自动过滤"] + ' </h4><p class="pop-text" style="display:block">' + n.join(", ") + "</p>",
                            i.show({
                                mask: !0,
                ...
                ballsErrorTip: function(t, e) {
                    var a = this,
                        ...
                        u = [];
                    if ("" != n.join("")) {
                        for (var d = 0; d < n.length; d++) $.trim(n[d].join("")) && u.push(n[d].join(""));
                        s = '<h4 class="pop-text" style="display:block;"> ' + translate["以下号码重复，已进行自动过滤"] + ' </h4><p class="pop-text" style="display:block">' + u.join(", ") + "</p>"
                    }
                    if ("" != i.join("")) {
                        for (var d = 0; d < i.length; d++) $.trim(i[d].join("")) && c.push(i[d].join(""));
                        r = '<h4 class="pop-text" style="display:block;"> ' + translate["以下号码错误，已进行自动过滤"] + ' </h4><p class="pop-text" style="display:block">' + c.join(", ") + "</p>"
                    }
                    l.show({
                        mask: !0,
