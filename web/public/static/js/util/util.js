!(function (e, t) {
      ...
      l
        ...
        : (r || (r = i(n)),
          (n = r.cache[e]
            ...
            : r.createElem(e)),
          n.canHaveChildren && !u.test(e) ? r.frag.appendChild(n) : n)
    );
  }
  function o(e, t) {
    t.cache ||
  ...
  var m = {
    ...
    createDocumentFragment: function (e, r) {
      ...
      for (
        var r = r || i(e), o = r.frag.cloneNode(), a = 0, s = n(), c = s.length;
        a < c;
        a++
      )
        o.createElement(s[a]);
  ...
  Array.prototype.map ||
    (Array.prototype.map = function (e, t) {
      ...
      for (arguments.length > 1 && (n = t), i = new Array(a), r = 0; r < a; ) {
        var s, l;
        r in o && ((s = o[r]), (l = e.call(n, s, r, o)), (i[r] = l)), r++;
      }
      return i;
    }),
  ...
  "undefined" == typeof Element.prototype.addEventListener &&
    (Element.prototype.addEventListener = function (e, t) {
      return (e = "on" + e), this.attachEvent(e, t);
    }),
  !(function (e, t) {
    function n(e) {
      var t = e.length,
    ...
    function i(e) {
      var t = (Ce[e] = {});
      return (
        le.each(e.match(ue) || [], function (e, n) {
          t[n] = !0;
        }),
        t
      );
    ...
    function r(e, n, i, r) {
      if (le.acceptData(e)) {
        ...
        if ((d && u[d] && (r || u[d].data)) || !l || i !== t)
          return (
            d || (c ? (e[s] = d = Z.pop() || le.guid++) : (d = s)),
            u[d] || ((u[d] = {}), c || (u[d].toJSON = le.noop)),
            ("object" != typeof n && "function" != typeof n) ||
              (r
                ? (u[d] = le.extend(u[d], n))
                : (u[d].data = le.extend(u[d].data, n))),
            (o = u[d]),
      ...
      var i,
        ...
        a =
          typeof e.getElementsByTagName !== X
            ...
            : typeof e.querySelectorAll !== X
            ? e.querySelectorAll(n || "*")
            : t;
      if (!a)
        for (a = [], i = e.childNodes || e; null != (r = i[o]); o++)
          !n || le.nodeName(r, n) ? a.push(r) : le.merge(a, x(r, n));
    ...
    function k(e, t) {
      if (t in e) return t;
      for (
        var n = t.charAt(0).toUpperCase() + t.slice(1), i = t, r = _t.length;
        r--;

      )
        if (((t = _t[r] + n), t in e)) return t;
      return i;
    }
    function w(e, t) {
      return (
          ...
          i.style &&
            ...
            t
              ? (o[a] || "none" !== n || (i.style.display = ""),
                "" === i.style.display &&
                  w(i) &&
                  (o[a] = le._data(i, "olddisplay", j(i.nodeName))))
              : o[a] ||
                ((r = w(i)),
                ((n && "none" !== n) || !r) &&
                  le._data(i, "olddisplay", r ? n : le.css(i, "display"))));
      for (a = 0; a < s; a++)
        (i = e[a]),
          i.style &&
    ...
    function S(e, t, n, i, r) {
      for (
        ...
        "margin" === n && (a += le.css(e, n + Ct[o], !0, r)),
          i
            ? ("content" === n && (a -= le.css(e, "padding" + Ct[o], !0, r)),
              "margin" !== n &&
                (a -= le.css(e, "border" + Ct[o] + "Width", !0, r)))
            : ((a += le.css(e, "padding" + Ct[o], !0, r)),
              "padding" !== n &&
                (a += le.css(e, "border" + Ct[o] + "Width", !0, r)));
      return a;
    }
          ...
          if ("*" !== c && c !== i) {
            if (((r = a[c + " " + i] || a["* " + i]), !r))
              for (n in a)
                if (
                  ((o = n.split(" ")),
                  o[1] === i && (r = a[c + " " + o[0]] || a["* " + o[0]]))
                ) {
                  r === !0
                    ? (r = a[n])
                    : a[n] !== !0 && ((i = o[0]), l.splice(s--, 0, i));
                  break;
                }
            if (r !== !0)
              if (r && e["throws"]) t = r(t);
    ...
    function R(e, t) {
      le.each(t, function (t, n) {
        for (
          var i = (on[t] || []).concat(on["*"]), r = 0, o = i.length;
          r < o;
          r++
        )
    ...
    function H(e, t, n) {
      var i,
        ...
        u = c.props;
      for (L(u, c.opts.specialEasing); o < a; o++)
    ...
    function L(e, t) {
      ...
      for (r in e)
        if (
          ...
          (o = t[i]),
          (n = e[r]),
          le.isArray(n) && ((o = n[1]), (n = e[r] = n[0])),
          r !== i && ((e[i] = n), delete e[r]),
          (a = le.cssHooks[i]),
          a && "expand" in a)
        ) {
      ...
      n.queue ||
        ...
        1 === e.nodeType &&
          ...
          "inline" === le.css(e, "display") &&
            "none" === le.css(e, "float") &&
            (le.support.inlineBlockNeedsLayout && "inline" !== j(e.nodeName)
              ? (p.zoom = 1)
    ...
    function $(e, t) {
      ...
      for (t = t ? 1 : 0; r < 4; r += 2 - t)
        (n = Ct[r]), (i["margin" + n] = i["padding" + n] = e);
    ...
    var G,
      ...
      we = function () {
        Q.addEventListener
          ? (Q.removeEventListener("DOMContentLoaded", ke, !1),
            e.removeEventListener("load", ke, !1))
          : (Q.detachEvent("onreadystatechange", ke),
    ...
    (le.fn = le.prototype = {
        ...
        if ("string" == typeof e) {
          ...
          if (r[1]) {
            if (
              ...
              pe.test(r[1]) && le.isPlainObject(n))
            )
              for (r in n)
                le.isFunction(this[r]) ? this[r](n[r]) : this.attr(r, n[r]);
            return this;
          }
          ...
          if (null != (o = arguments[l]))
            for (r in o)
              (e = s[r]),
                (i = o[r]),
                s !== i &&
                  (u && i && (le.isPlainObject(i) || (n = le.isArray(i)))
                    ? (n
      ...
      le.extend({
        noConflict: function (t) {
          return (
            e.$ === le && (e.$ = K), t && e.jQuery === le && (e.jQuery = Y), le
          );
        },
        isReady: !1,
        readyWait: 1,
        ...
        ready: function (e) {
          if (e === !0 ? !--le.readyWait : !le.isReady) {
            ...
            (le.isReady = !0),
              (e !== !0 && --le.readyWait > 0) ||
                (G.resolveWith(Q, [le]),
                le.fn.trigger && le(Q).trigger("ready").off("ready"));
          }
        },
        ...
        parseJSON: function (t) {
          return e.JSON && e.JSON.parse
            ...
            : "string" == typeof t &&
              ((t = le.trim(t)),
              t && he.test(t.replace(ge, "@").replace(ve, "]").replace(me, "")))
        ...
        makeArray: function (e, t) {
          ...
          return (
            null != e &&
              (n(Object(e))
                ? le.merge(i, "string" == typeof e ? [e] : e)
                : ne.call(i, e)),
            i
          );
        },
        ...
        map: function (e, t, i) {
          ...
          else for (o in e) (r = t(e[o], o, i)), null != r && (l[l.length] = r);
          return te.apply([], l);
        },
        guid: 1,
        proxy: function (e, n) {
      ...
      (le.ready.promise = function (t) {
        if (!G)
          if (((G = le.Deferred()), "complete" === Q.readyState))
            setTimeout(le.ready);
          else if (Q.addEventListener)
            Q.addEventListener("DOMContentLoaded", ke, !1),
    ...
    (le.Callbacks = function (e) {
      e = "string" == typeof e ? Ce[e] || i(e) : le.extend({}, e);
      var n,
        r,
        o,
        a,
        ...
        d = function (t) {
          for (
            r = e.memory && t, o = !0, s = l || 0, l = 0, a = c.length, n = !0;
            c && s < a;
            s++
          )
          ...
          le(function () {
            ...
            a &&
              ...
              e.getComputedStyle &&
                ...
                (i = d.appendChild(Q.createElement("div"))),
    ...
    le.extend({
      ...
      hasData: function (e) {
        return (
          (e = e.nodeType ? le.cache[e[le.expando]] : e[le.expando]),
          !!e && !s(e)
        );
      },
      data: function (e, t, n) {
          ...
          if (e === t) {
            if (
              ...
              for (i = o.attributes; s < i.length; s++)
                (r = i[s].name),
                  r.indexOf("data-") ||
                    ((r = le.camelCase(r.slice(5))), a(o, r, l[r]));
    ...
    le.fn.extend({
      ...
      toggleClass: function (e, t) {
        ...
        return le.isFunction(e)
          ...
          : this.each(function () {
              if ("string" === n)
                for (
                  var r, o = 0, a = le(this), s = t, l = e.match(ue) || [];
                  (r = l[o++]);
      ...
      hasClass: function (e) {
        for (var t = " " + e + " ", n = 0, i = this.length; n < i; n++)
          if (
            1 === this[n].nodeType &&
            (" " + this[n].className + " ").replace(Ee, " ").indexOf(t) >= 0
          )
            return !0;
        return !1;
      },
      val: function (e) {
        ...
        return arguments.length
          ...
          : o
          ? ((i = le.valHooks[o.type] || le.valHooks[o.nodeName.toLowerCase()]),
          ...
          if (e && 3 !== s && 8 !== s && 2 !== s)
            return typeof e.getAttribute === X
              ...
              : ((o = 1 !== s || !le.isXMLDoc(e)),
                o &&
                  ((n = n.toLowerCase()),
                  (r = le.attrHooks[n] || (Ne.test(n) ? je : Te))),
                i === t
                  ? r && o && "get" in r && null !== (a = r.get(e, n))
                    ? a
                    : (typeof e.getAttribute !== X && (a = e.getAttribute(n)),
                      null == a ? t : a)
                  : null !== i
                  ? r && o && "set" in r && (a = r.set(e, i, n)) !== t
                    ? a
          ...
          if (o && 1 === e.nodeType)
            for (; (n = o[r++]); )
              (i = le.propFix[n] || n),
                Ne.test(n)
                  ? !Be && Me.test(n)
                    ? (e[le.camelCase("default-" + n)] = e[i] = !1)
                    : (e[i] = !1)
                  : le.attr(e, n, ""),
          ...
          tabIndex: {
            get: function (e) {
              ...
              return n && n.specified
                ? parseInt(n.value, 10)
                : Ae.test(e.nodeName) || (Pe.test(e.nodeName) && e.href)
                ? 0
                : t;
            },
          },
        ...
        set: function (e, t, n) {
          return (
            t === !1
              ? le.removeAttr(e, n)
              : (Ie && Be) || !Me.test(n)
              ? e.setAttribute((!Be && le.propFix[n]) || n, n)
    ...
    (le.event = {
      ...
      add: function (e, n, i, r, o) {
        ...
        if (v) {
          for (
            i.handler && ((c = i), (i = c.handler), (o = c.selector)),
              i.guid || (i.guid = le.guid++),
              (s = v.events) || (s = v.events = {}),
              (d = v.handle) ||
                ((d = v.handle = function (e) {
                  return typeof le === X || (e && le.event.triggered === e.type)
                    ? t
                    : le.event.dispatch.apply(d.elem, arguments);
                }),
                (d.elem = e)),
              n = (n || "").match(ue) || [""],
              l = n.length;
            ...
            (a = Le.exec(n[l]) || []),
              ...
              u.add &&
                (u.add.call(e, f), f.handler.guid || (f.handler.guid = i.guid)),
      ...
      trigger: function (n, i, r, o) {
        ...
        if (
          ...
          3 !== r.nodeType &&
            8 !== r.nodeType &&
            !He.test(h + le.event.triggered) &&
            (h.indexOf(".") >= 0 &&
              ((m = h.split(".")), (h = m.shift()), m.sort()),
            (s = h.indexOf(":") < 0 && "on" + h),
            (n = n[le.expando]
              ? n
              : new le.Event(h, "object" == typeof n && n)),
            (n.isTrigger = !0),
            (n.namespace = m.join(".")),
          ...
          if (!o && !u.noBubble && !le.isWindow(r)) {
            for (
              c = u.delegateType || h, He.test(c + h) || (l = l.parentNode);
              l;
              l = l.parentNode
            )
              p.push(l), (d = l);
          ...
          if (
            ...
            !o &&
              ...
              (!u._default || u._default.apply(r.ownerDocument, i) === !1) &&
              ("click" !== h || !le.nodeName(r, "a")) &&
              le.acceptData(r) &&
              s &&
              r[h] &&
              !le.isWindow(r))
          ) {
            (d = r[s]), d && (r[s] = null), (le.event.triggered = h);
            try {
              r[h]();
            } catch (g) {}
            (le.event.triggered = t), d && (r[s] = d);
          }
          return n.result;
        }
      },
      dispatch: function (e) {
        ...
        if (
          ...
          for (
            s = le.event.handlers.call(this, e, c), n = 0;
      ...
      fix: function (e) {
        ...
        for (
          ...
          (n = i[t]), (e[n] = o[n]);
        return (
          e.target || (e.target = o.srcElement || Q),
      ...
      (le.removeEvent = Q.removeEventListener
        ...
        : function (e, t, n) {
            var i = "on" + t;
            e.detachEvent &&
              (typeof e[i] === X && (e[i] = null), e.detachEvent(i, n));
          }),
      ...
      le.support.submitBubbles ||
        (le.event.special.submit = {
                  ...
                  var n = e.target,
                    i =
                      le.nodeName(n, "input") || le.nodeName(n, "button")
                        ...
                        : t;
                  i &&
                    !le._data(i, "submitBubbles") &&
                    (le.event.add(i, "submit._submit", function (e) {
                      e._submit_bubble = !0;
                    }),
          ...
          teardown: function () {
            return (
              !le.nodeName(this, "form") &&
              void le.event.remove(this, "._submit")
            );
          },
        }),
          ...
          setup: function () {
            return Oe.test(this.nodeName)
              ? (("checkbox" !== this.type && "radio" !== this.type) ||
                ...
                !1)
              : void le.event.add(this, "beforeactivate._change", function (e) {
                  var t = e.target;
                  Oe.test(t.nodeName) &&
          ...
          if (!M && !i) {
            if ((r = me.exec(e)))
              if ((a = r[1])) {
                ...
                if (r[2])
                  return K.apply(n, J.call(t.getElementsByTagName(e), 0)), n;
                if ((a = r[3]) && q.getByClassName && t.getElementsByClassName)
                  return K.apply(n, J.call(t.getElementsByClassName(a), 0)), n;
              }
            if (q.qsa && !B.test(e)) {
              if (
                ((u = !0),
              ...
              if (m)
                try {
                  return K.apply(n, J.call(h.querySelectorAll(m), 0)), n;
                } catch (g) {
                } finally {
          ...
          return (
            ...
            r(function (r, a, s, l) {
              var c,
                ...
                y = n ? (o || (r ? e : h || i) ? [] : a) : v;
              if ((n && n(v, y, s, l), i))
                for (c = m(y, p), i(c, [], s, l), u = c.length; u--; )
                  (d = c[u]) && (y[p[u]] = !(v[p[u]] = d));
              if (r) {
                if (o || e) {
                  if (o) {
          ...
          for (
            ...
            if ((n = _.relative[e[s].type])) u = [p(h(u), n)];
              ...
              if (((n = _.filter[e[s].type].apply(null, e[s].matches)), n[H])) {
                ...
                return g(
                  s > 1 && h(u),
                  s > 1 && f(e.slice(0, s - 1)).replace(ae, "$1"),
                  n,
                  s < i && v(e.slice(s, i)),
                  i < r && v((e = e.slice(i))),
                  i < r && f(e)
        ...
        function b(e, t, n, i) {
          ...
          if (!i && 1 === c.length) {
            if (
              ...
              if (((t = _.find.ID(a.matches[0].replace(be, ke), t)[0]), !t))
                return n;
            ...
            for (
              ...
              if (
                (l = _.find[s]) &&
                (i = l(
                  a.matches[0].replace(be, ke),
                  (pe.test(o[0].type) && t.parentNode) || t
                ))
              ) {
                if ((o.splice(r, 1), (e = i.length && f(o)), !e))
                  return K.apply(n, J.call(i, 0)), n;
                break;
              }
          }
          return j(e, c)(i, t, M, n, pe.test(e)), n;
        }
        function k() {}
        var w,
          C,
        ...
        (T = a.isXML = function (e) {
          ...
          (A = a.setDocument = function (e) {
            ...
            return i !== P && 9 === i.nodeType && i.documentElement
              ? ((P = i),
                (N = i.documentElement),
                (M = T(i)),
                (q.tagNameNoComments = o(function (e) {
                  return (
                ...
                (q.getByName = o(function (e) {
                  ...
                  return (
                    (q.getIdNotName = !i.getElementById(H)), N.removeChild(e), t
                  );
                })),
                (_.attrHandle = o(function (e) {
                  return (
                    ...
                    e.firstChild &&
                      typeof e.firstChild.getAttribute !== X &&
                ...
                (_.find.NAME =
                  q.getByName &&
                  function (e, t) {
                    if (typeof t.getElementsByName !== X)
                      return t.getElementsByName(name);
                  }),
                (_.find.CLASS =
                  q.getByClassName &&
                  function (e, t) {
                    if (typeof t.getElementsByClassName !== X && !M)
                      return t.getElementsByClassName(e);
                  }),
                (I = []),
                (B = [":focus"]),
                (q.qsa = n(i.querySelectorAll)) &&
                  (o(function (e) {
                    (e.innerHTML =
          ...
          (a.matchesSelector = function (e, t) {
            if (
              ...
              (t = t.replace(xe, "='$1']")),
              q.matchesSelector && !M && (!I || !I.test(t)) && !B.test(t))
            )
              try {
                var n = O.call(e, t);
                if (
    ...
    le.fn.extend({
      find: function (e) {
        ...
        return (
          (n = this.pushStack(r > 1 ? le.unique(n) : n)),
      ...
      closest: function (e, t) {
        for (
          var n,
            ...
            o = [],
            a =
              ze.test(e) || "string" != typeof e ? le(e, t || this.context) : 0;
          i < r;
          i++
        )
          for (
    ...
    (at.optgroup = at.option),
      ...
      le.fn.extend({
        ...
        remove: function (e, t) {
          for (var n, i = 0; null != (n = this[i]); i++)
            (!e || le.filter(e, [n]).length > 0) &&
              ...
              n.parentNode &&
                (t && le.contains(n.ownerDocument, n) && g(x(n, "script")),
                n.parentNode.removeChild(n)));
          return this;
        },
        empty: function () {
          ...
          return le.access(
            ...
            function (e) {
              var n = this[0] || {},
                ...
                r = this.length;
              if (e === t)
                return 1 === n.nodeType ? n.innerHTML.replace(Xe, "") : t;
              if (
                "string" == typeof e &&
                !et.test(e) &&
                (le.support.htmlSerialize || !Qe.test(e)) &&
                (le.support.leadingWhitespace || !Ve.test(e)) &&
                !at[(Ke.exec(e) || ["", ""])[1].toLowerCase()]
              ) {
                e = e.replace(Ye, "<$1></$2>");
                try {
                  for (; i < r; i++)
                    (n = this[i] || {}),
                      1 === n.nodeType &&
                        (le.cleanData(x(n, !1)), (n.innerHTML = e));
                  n = 0;
                } catch (o) {}
              }
        ...
        domManip: function (e, n, i) {
          ...
          if (
            y ||
            (!(d <= 1 || "string" != typeof v || le.support.checkClone) &&
              nt.test(v))
          )
          ...
          if (
            d &&
            ((c = le.buildFragment(e, this[0].ownerDocument, !1, this)),
            (r = c.firstChild),
            1 === c.childNodes.length && (c = r),
            r)
          ) {
            for (
              n = n && le.nodeName(r, "tr"),
                s = le.map(x(c, "script"), h),
                a = s.length;
              u < d;
              u++
            )
              (o = c),
                u !== g &&
                  ((o = le.clone(o, !0, !0)), a && le.merge(s, x(o, "script"))),
                i.call(
                  n && le.nodeName(this[u], "table")
                    ? p(this[u], "tbody")
                    : this[u],
                  o,
                  u
            ...
            if (a)
              for (
                l = s[s.length - 1].ownerDocument, le.map(s, m), u = 0;
                u < a;
                u++
              )
                (o = s[u]),
      ...
      le.each(
        ...
        function (e, t) {
          le.fn[e] = function (e) {
            for (var n, i = 0, r = [], o = le(e), a = o.length - 1; i <= a; i++)
      ...
      le.extend({
        ...
        buildFragment: function (e, t, n, i) {
          for (
            var r, o, a, s, l, c, u, d = e.length, p = f(t), h = [], m = 0;
            m < d;
            m++
          )
            if (((o = e[m]), o || 0 === o))
              if ("object" === le.type(o)) le.merge(h, o.nodeType ? [o] : o);
                ...
                if (
                  (!le.support.leadingWhitespace &&
                    Ve.test(o) &&
                    h.push(t.createTextNode(Ve.exec(o)[0])),
                  !le.support.tbody)
                )
                  for (
                    o =
                    ...
                    le.nodeName((c = o.childNodes[r]), "tbody") &&
                      !c.childNodes.length &&
                      o.removeChild(c);
                for (
          ...
          for (
            s && p.removeChild(s),
              le.support.appendChecked || le.grep(x(h, "input"), b),
              m = 0;
            (o = h[m++]);
        ...
        cleanData: function (e, t) {
          for (
            ...
            if ((t || le.acceptData(n)) && ((r = n[s]), (o = r && l[r]))) {
              if (o.events)
                for (i in o.events)
                  u[i] ? le.event.remove(n, i) : le.removeEvent(n, i, o.handle);
              l[r] &&
                (delete l[r],
                c
                  ? delete n[s]
                  : typeof n.removeAttribute !== X
                  ? n.removeAttribute(s)
                  : (n[s] = null),
                Z.push(r));
            }
      ...
      le.extend({
        ...
        style: function (e, n, i, r) {
          if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
            var o,
              ...
              c = e.style;
            if (
              ((n = le.cssProps[l] || (le.cssProps[l] = k(c, l))),
            ...
            if (
              ...
              "string" === a &&
                (o = xt.exec(i)) &&
                ((i = (o[1] + 1) * o[2] + parseFloat(le.css(e, n))),
                (a = "number")),
              !(
                null == i ||
                ("number" === a && isNaN(i)) ||
                ("number" !== a || le.cssNumber[l] || (i += "px"),
        ...
        css: function (e, n, i, r) {
          var o,
            ...
            l = le.camelCase(n);
          return (
            (n = le.cssProps[l] || (le.cssProps[l] = k(e.style, l))),
            (s = le.cssHooks[n] || le.cssHooks[l]),
            s && "get" in s && (a = s.get(e, !0, i)),
            a === t && (a = dt(e, n, r)),
            "normal" === a && n in wt && (a = wt[n]),
            "" === i || i
              ? ((o = parseFloat(a)), i === !0 || le.isNumeric(o) ? o || 0 : a)
              : a
          );
        },
            ...
            return _(
              ...
              i
                ? S(
                    ...
                    i,
                    le.support.boxSizing &&
                      "border-box" === le.css(e, "boxSizing", !1, r),
                    r
                  )
                : 0
            );
      ...
      le.support.opacity ||
        (le.cssHooks.opacity = {
          ...
          set: function (e, t) {
            ...
            (n.zoom = 1),
              ((t >= 1 || "" === t) &&
                "" === le.trim(o.replace(ft, "")) &&
                n.removeAttribute &&
                (n.removeAttribute("filter"), "" === t || (i && !i.filter))) ||
                (n.filter = ft.test(o) ? o.replace(ft, r) : o + " " + r);
          },
        }),
      le(function () {
        le.support.reliableMarginRight ||
          (le.cssHooks.marginRight = {
            get: function (e, t) {
              if (t)
                return le.swap(e, { display: "inline-block" }, dt, [
                  e,
                  "marginRight",
                ]);
            },
    ...
    (At = Lt.exec(Pt.toLowerCase()) || []),
      ...
      le.each(["get", "post"], function (e, n) {
        le[n] = function (e, i, r, o) {
          return (
            le.isFunction(i) && ((o = o || r), (r = i), (i = t)),
            le.ajax({ url: e, type: n, dataType: o, data: i, success: r })
          );
        };
      }),
      le.extend({
        ...
        ajax: function (e, n) {
          function i(e, n, i, r) {
            ...
            2 !== b &&
              ...
              (w.status = e),
              (w.statusText = (n || C) + ""),
              o ? m.resolveWith(p, [d, C, w]) : m.rejectWith(p, [w, C, y]),
              w.statusCode(v),
              (v = t),
              c &&
                h.trigger(o ? "ajaxSuccess" : "ajaxError", [w, f, o ? d : y]),
              g.fireWith(p, [w, C]),
              c &&
          ...
          if (
            ...
            f.data &&
              ...
              (f.data = le.param(f.data, f.traditional)),
            P(Wt, f, n, w),
            2 === b)
          )
            return w;
      ...
      le.ajaxTransport("script", function (e) {
        if (e.crossDomain) {
          var n,
            i = Q.head || le("head")[0] || Q.documentElement;
          return {
            send: function (t, r) {
    ...
    le.ajaxSetup({
      ...
      le.ajaxPrefilter("json jsonp", function (n, i, r) {
        ...
        if (l || "jsonp" === n.dataTypes[0])
          return (
            (o = n.jsonpCallback = le.isFunction(n.jsonpCallback)
              ? n.jsonpCallback()
              : n.jsonpCallback),
            l
              ? (n[l] = n[l].replace(Xt, "$1" + o))
              : n.jsonp !== !1 &&
        ...
        "*": [
          function (e, t) {
            ...
            if (o) {
              if (
                ((n = +o[2]),
                (i = o[3] || (le.cssNumber[e] ? "" : "px")),
                "px" !== i && s)
              ) {
                s = le.css(r.elem, e, !0) || n || 1;
                do (l = l || ".5"), (s /= l), le.style(r.elem, e, s + i);
    ...
    (le.Animation = le.extend(H, {
      tweener: function (e, t) {
        ...
        for (var n, i = 0, r = e.length; i < r; i++)
          (n = e[i]), (on[n] = on[n] || []), on[n].unshift(t);
      },
      ...
      (le.fn.offset = function (e) {
        ...
        return a
          ? ((n = a.documentElement),
            le.contains(n, o)
              ? (typeof o.getBoundingClientRect !== X &&
      ...
      (le.offset = {
        setOffset: function (e, t, n) {
          ...
          var r,
            ...
            u =
              ("absolute" === i || "fixed" === i) &&
              le.inArray("auto", [l, c]) > -1,
            d = {},
            f = {};
          u
            ? ((f = a.position()), (r = f.top), (o = f.left))
      ...
      le.fn.extend({
        ...
        offsetParent: function () {
          return this.map(function () {
            for (
              var e = this.offsetParent || Q.documentElement;
              e &&
              !le.nodeName(e, "html") &&
              "static" === le.css(e, "position");
  ...
  !(function (e) {
    ...
    function n(e) {
      var t = document.createElement("input"),
        ...
        i = n in t;
      return (
        i || (t.setAttribute(n, "return;"), (i = "function" == typeof t[n])),
        (t = null),
        i
      );
    }
    function i(t, n) {
      var i = t.getAttribute("type"),
        r =
          ("INPUT" === t.tagName && -1 !== e.inArray(i, n.supportsInputType)) ||
          t.isContentEditable ||
          "TEXTAREA" === t.tagName;
      if (!r) {
    ...
    function o(t, n, i) {
      ...
      var a,
        ...
        l,
        c,
        u = t.getAttribute("data-inputmask");
      if (
        (u &&
          "" !== u &&
    ...
    function a(n, i) {
      function r(t) {
        ...
        function r(t, i, r) {
          ...
          var a = t.matches[r - 1];
          if (o && !v) {
            o.placeholder = e.isFunction(o.placeholder)
              ? o.placeholder(n)
              : o.placeholder;
            for (
              var s = o.prevalidator, l = s ? s.length : 0, c = 1;
              c < o.cardinality;
              c++
            ) {
              var u = l >= c ? s[c - 1] : [],
              ...
              t.matches.splice(r++, 0, {
                ...
                newBlockMarker:
                  void 0 === a || a.def !== (o.definitionSymbol || i),
                casing: o.casing,
        ...
        function o(e, t) {
          e.isGroup &&
            ((e.isGroup = !1),
            r(e, n.groupmarker.start, 0),
            t !== !0 && r(e, n.groupmarker.end));
        }
        function a(e, t, n, i) {
          t.matches.length > 0 &&
            (void 0 === i || i) &&
            ((n = t.matches[t.matches.length - 1]), o(n)),
            r(t, e);
        }
        function s() {
          if (x.length > 0) {
            if (
              ...
              x.length > 0
                ? ((f = x[x.length - 1]), f.matches.push(p))
                : y.matches.push(p);
            }
          } else a(u, y, h);
        }
        function l(e) {
          function t(e) {
            return (
              e === n.optionalmarker.start
                ? (e = n.optionalmarker.end)
                : e === n.optionalmarker.end
                ? (e = n.optionalmarker.start)
                : e === n.groupmarker.start
                ? (e = n.groupmarker.end)
                : e === n.groupmarker.end && (e = n.groupmarker.start),
              e
            );
          }
            ...
            switch (u.charAt(0)) {
              ...
              case n.groupmarker.end:
                if (((d = x.pop()), void 0 !== d))
                  if (x.length > 0) {
                    if (
                      ((f = x[x.length - 1]), f.matches.push(d), f.isAlternator)
                    ) {
                      p = x.pop();
              ...
              case n.alternatormarker:
                x.length > 0
                  ? ((f = x[x.length - 1]), (h = f.matches.pop()))
                  : (h = y.matches.pop()),
                  h.isAlternator
                    ? x.push(h)
                    : ((p = new i(!1, !1, !1, !0)),
        ...
        for (; x.length > 0; ) (d = x.pop()), o(d, !0), y.matches.push(d);
        return (
          y.matches.length > 0 &&
            ((h = y.matches[y.matches.length - 1]), o(h), b.push(y)),
        ...
        if (null !== o && "" !== o) {
          if (
            ...
            o =
              ...
              o +
              n.groupmarker.end +
              n.quantifiermarker.start +
              s +
              "," +
              n.repeat +
              n.quantifiermarker.end;
          }
          var l;
          return (
            void 0 === t.prototype.masksCache[o] || i === !0
              ? ((l = {
                  mask: o,
                  maskToken: r(o),
                  validPositions: {},
                ...
                i !== !0 &&
                  ((t.prototype.masksCache[
                    n.numericInput ? o.split("").reverse().join("") : o
                  ] = l),
                  (l = e.extend(
                    !0,
                    {},
      ...
      if ((e.isFunction(n.mask) && (n.mask = n.mask(n)), e.isArray(n.mask))) {
        if (n.mask.length > 1) {
          ...
          var l = "(";
          return (
            e.each(n.numericInput ? n.mask.reverse() : n.mask, function (t, n) {
              l.length > 1 && (l += ")|("),
                (l += a(
                  void 0 === n.mask || e.isFunction(n.mask) ? n : n.mask
                ));
            }),
            (l += ")"),
            o(l, n.mask)
      ...
      return (
        n.mask &&
          (s =
            void 0 === n.mask.mask || e.isFunction(n.mask.mask)
              ? o(a(n.mask), n.mask)
              : o(a(n.mask.mask), n.mask)),
        s
      );
    }
    function s(r, o, a) {
        ...
        do {
          if (e === !0 && f().validPositions[l]) {
            ...
            (o = v(l, i, l - 1)),
              ...
              (a.jitMasking === !1 ||
                c > l ||
                (isFinite(a.jitMasking) && a.jitMasking > l)) &&
                s.push(B(l, r));
          l++;
        } while (
          ((void 0 === fe || fe > l - 1) && null !== r.fn) ||
          (null === r.fn && "" !== r.def) ||
          t >= l
        );
      ...
      function m(t, n, i) {
        if (a.insertMode && void 0 !== f().validPositions[t] && void 0 === i) {
          ...
          for (r = l = t; s >= r; r++) {
            ...
            if (void 0 !== d)
              for (
                ...
                ((null == d.match.fn &&
                  u[r] &&
                  (u[r].match.optionalQuantifier === !0 ||
                    u[r].match.optionality === !0)) ||
                  null != d.match.fn);
                ...
                if (
                  ...
                  (!a.keepStatic &&
                    u[r] &&
                    ((void 0 !== u[r + 1] &&
                      k(r + 1, u[r].locator.slice(), r).length > 1) ||
                      void 0 !== u[r].alternation))
                    ? m++
                    : (m = A(l)),
                  x(m, d.match.def))
                ) {
                  var v = j(m, d.input, !0, !0);
                  (c = v !== !1), (l = v.caret || v.insert ? h() : m);
                  break;
                }
          ...
          if (!c) return (f().validPositions = e.extend(!0, {}, o)), p(!0), !1;
      ...
      function g(e, t, n, i) {
        var r,
          o = e;
        for (f().p = e, r = o; t > r; r++)
          void 0 !== f().validPositions[r] &&
            (n === !0 || a.canClearPosition(f(), r, h(), i, a) !== !1) &&
        ...
        for (r = o + 1; r <= h(); ) {
          ...
          if (
            (o > r && (r = o + 1),
            (void 0 === f().validPositions[r] && E(r)) || void 0 !== s)
          )
            r++;
          else {
            var l = v(r);
        ...
        for (
          i !== !0 &&
            n !== !0 &&
            void 0 !== f().validPositions[c] &&
            f().validPositions[c].input === a.radixPoint &&
            delete f().validPositions[c],
            r = c + 1;
          u >= r;
          r++
        )
          f().validPositions[r] && delete f().validPositions[r];
        p(!0);
      }
      function v(e, t, n) {
            ...
            !(
              ...
              (void 0 === s.alternation ||
                ...
                (void 0 !== i.locator[s.alternation] &&
                  T(i.locator[s.alternation].toString().split(","), l)))
            ));
            c++
          );
        return i;
      ...
      function y(e) {
        return f().validPositions[e]
          ? f().validPositions[e].match
          : k(e)[0].match;
      }
      function x(e, t) {
      ...
      function b(t, n) {
        var i, r;
        return (
          (f().tests[t] || f().validPositions[t]) &&
            e.each(f().tests[t] || [f().validPositions[t]], function (e, t) {
              var o = t.alternation
                ? t.locator[t.alternation].toString().indexOf(n)
                : -1;
      ...
      function k(t, n, i) {
        function r(n, i, o, s) {
          function c(o, s, h) {
            ...
            if (l === t && void 0 === o.matches)
              return u.push({ match: o, locator: s.reverse(), cd: p }), !0;
            if (void 0 !== o.matches) {
              if (o.isGroup && h !== o) {
                if ((o = c(n.matches[e.inArray(o, n.matches) + 1], s)))
                  return !0;
                ...
                if (-1 === _ || "string" == typeof _) {
                  ...
                  for (var D = 0; D < E.length; D++) {
                    if (
                      ...
                      (i = g(l, S)),
                      (o =
                        c(x.matches[S] || n.matches[S], [S].concat(s), h) || o),
                      o !== !0 &&
                        void 0 !== o &&
                        E[E.length - 1] < x.matches.length)
                    ) {
                      var A = e.inArray(o, n.matches) + 1;
                      n.matches.length > A &&
                        ((o = c(
                          n.matches[A],
                          [A].concat(s.slice(1, s.length)),
                          h
                        )),
                        o &&
                          (E.push(A.toString()),
                    ...
                    for (var N = 0; N < y.length; N++) {
                      ...
                      for (var B = 0; B < k.length; B++) {
                        var I = k[B];
                        if (
                          M.match.def === I.match.def &&
                          ("string" != typeof _ ||
                            -1 !==
                              e.inArray(M.locator[M.alternation].toString(), E))
                        ) {
                          M.match.mask === I.match.mask &&
                            (y.splice(N, 1), N--),
                            -1 ===
                              I.locator[M.alternation]
                                .toString()
                                .indexOf(M.locator[M.alternation]) &&
                              ((I.locator[M.alternation] =
                                I.locator[M.alternation] +
                                "," +
                                M.locator[M.alternation]),
                              (I.alternation = M.alternation));
                          break;
                        }
                      }
                    }
                ...
                o.isQuantifier &&
                h !== n.matches[e.inArray(o, n.matches) - 1]
              )
                for (
                  var O = o, F = i.length > 0 ? i.shift() : 0;
                  F < (isNaN(O.quantifier.max) ? F + 1 : O.quantifier.max) &&
                  t >= l;
                  F++
                ) {
                  ...
                  if ((o = c(R, [F].concat(s), R))) {
                    if (
                      ...
                      (a.optionalQuantifier = F > O.quantifier.min - 1),
                      m(a, R))
                    ) {
        ...
        if (t > -1) {
          if (void 0 === n) {
            for (
              var h, m = t - 1;
              void 0 === (h = f().validPositions[m] || f().tests[m]) && m > -1;

            )
              m--;
            void 0 !== h &&
              m > -1 &&
              ((c = o(h)), (p = c.join("")), (h = h[0] || h), (l = m));
          }
      ...
      function w() {
        return void 0 === f()._buffer && (f()._buffer = l(!1, 1)), f()._buffer;
      }
      function C(e) {
        if (void 0 === f().buffer || e === !0) {
          if (e === !0)
            for (var t in f().tests)
              void 0 === f().validPositions[t] && delete f().tests[t];
          f().buffer = l(!0, h(), !0);
        }
        return f().buffer;
      }
      function _(e, t, n) {
        var i;
        if (((n = n), e === !0)) p(), (e = 0), (t = n.length);
        else
          for (i = e; t > i; i++)
            delete f().validPositions[i], delete f().tests[i];
        for (i = e; t > i; i++)
          p(!0), n[i] !== a.skipOptionalPartCharacter && j(i, n[i], !0, !0);
      }
      function S(e, t) {
        switch (t.casing) {
          case "upper":
      ...
      function T(t, n) {
        for (
          var i = a.greedy ? n : n.slice(0, 1), r = !1, o = 0;
          o < t.length;
          o++
        )
      ...
      function j(t, n, i, r) {
        function o(t, n, i, r) {
          ...
          return (
            e.each(k(t), function (s, l) {
              for (
                var c = l.match, u = n ? 1 : 0, d = "", v = c.cardinality;
                v > u;
                v--
              )
                d += N(t - (v - 1));
              if (
                ...
                (o =
                  null != c.fn
                    ? c.fn.test(d, f(), t, i, a)
                    : (n === c.def || n === a.skipOptionalPartCharacter) &&
                      "" !== c.def && { c: c.placeholder || c.def, pos: t }),
                o !== !1)
              ) {
                var y = void 0 !== o.c ? o.c : n;
                y =
                  y === a.skipOptionalPartCharacter && null === c.fn
                    ? c.placeholder || c.def
                    : y;
                var x = t,
                  b = C();
                if (
                  ...
                  if (
                    ((i = !0),
                    _(k === !0 ? k : k.start, k.end, b),
                    void 0 === o.pos && void 0 === o.c)
                  )
                    return (o.pos = h()), !1;
                  if (((x = void 0 !== o.pos ? o.pos : t), x !== t))
                    return (o = e.extend(o, j(x, y, !0, r))), !1;
                } else if (
                  o !== !0 &&
                  void 0 !== o.pos &&
                  o.pos !== t &&
                  ((x = o.pos), _(t, x, C().slice()), x !== t)
                )
                  return (o = e.extend(o, j(x, y, !0))), !1;
                return (
                  (o === !0 || void 0 !== o.pos || void 0 !== o.c) &&
                  (s > 0 && p(!0),
                  m(x, e.extend({}, l, { input: S(y, c) }), r) || (o = !1),
                  !1)
                );
              }
            }),
        ...
        function s(t, n, i, r) {
          for (
            var o,
              ...
              u,
              d,
              m = e.extend(!0, {}, f().validPositions),
              g = e.extend(!0, {}, f().tests),
              y = h();
            y >= 0 &&
            ((c = f().validPositions[y]),
            !c ||
              void 0 === c.alternation ||
              ((o = y),
              (s = f().validPositions[o].alternation),
              v(o).locator[c.alternation] === c.locator[c.alternation]));
            y--
          );
          if (void 0 !== s) {
            o = parseInt(o);
            for (var x in f().validPositions)
              if (
                ((x = parseInt(x)),
                (c = f().validPositions[x]),
                x >= o && void 0 !== c.alternation)
              ) {
                var k;
                0 === o
                  ? ((k = []),
                    e.each(f().tests[o], function (e, t) {
                      void 0 !== t.locator[s] &&
                        (k = k.concat(t.locator[s].toString().split(",")));
                    }))
                  : (k = f()
                      .validPositions[o].locator[s].toString()
                      .split(","));
                ...
                for (var C = 0; C < k.length; C++) {
                  var _ = [],
                    ...
                    T = 0;
                  if (w < k[C]) {
                    for (var E, D, A = x; A >= 0; A--)
                      if (((E = f().validPositions[A]), void 0 !== E)) {
                        var P = b(A, k[C]);
                        f().validPositions[A].match.def !== P.match.def &&
                          (_.push(f().validPositions[A].input),
                          (f().validPositions[A] = P),
                          (f().validPositions[A].input = B(A)),
                          null === f().validPositions[A].match.fn && T++,
                          (E = P)),
                          (D = E.locator[s]),
                    ...
                    if (w !== E.locator[s]) {
                      for (u = x + 1; u < h(void 0, !0) + 1; u++)
                        (d = f().validPositions[u]),
                          d && null != d.match.fn
                            ? _.push(d.input)
                            : t > u && S++,
                          ...
                          delete f().tests[u];
                      for (
                        p(!0), a.keepStatic = !a.keepStatic, l = !0;
                        _.length > 0;

                      ) {
                        var N = _.shift();
                        if (
                          N !== a.skipOptionalPartCharacter &&
                          !(l = j(h(void 0, !0) + 1, N, !1, r))
                        )
                          break;
                      }
                        ...
                        for (u = x + 1; u < h() + 1; u++)
                          (d = f().validPositions[u]),
                            (void 0 === d || null == d.match.fn) &&
                              t > u &&
                              T++;
                        (t += T - S), (l = j(t > M ? M : t, n, i, r));
                      }
                      if (((a.keepStatic = !a.keepStatic), l)) return l;
                      p(),
                        (f().validPositions = e.extend(!0, {}, m)),
                        (f().tests = e.extend(!0, {}, g));
                    }
                  }
                }
                break;
        ...
        function l(t, n) {
          for (
            var i = f().validPositions[n], r = i.locator, o = r.length, a = t;
            n > a;
            a++
          )
            if (void 0 === f().validPositions[a] && !E(a, !0)) {
              var s = k(a),
                l = s[0],
                c = -1;
        ...
        for (u++; t > u; u++)
          void 0 === f().validPositions[u] &&
            (((!E(u) || c[u] !== B(u)) && k(u).length > 1) ||
              c[u] === a.radixPoint ||
              ("0" === c[u] && e.inArray(a.radixPoint, c) < u)) &&
            o(u, c[u], !0, r);
        var d = t,
          y = !1,
          x = e.extend(!0, {}, f().validPositions);
        if (d < D() && ((y = o(d, n, i, r)), (!i || r === !0) && y === !1)) {
          var w = f().validPositions[d];
          if (
            !w ||
            null !== w.match.fn ||
            (w.match.def !== n && n !== a.skipOptionalPartCharacter)
          ) {
            if (
              (a.insertMode || void 0 === f().validPositions[A(d)]) &&
              !E(d, !0)
            ) {
              var P = v(d).match,
                P = P.placeholder || P.def;
              o(d, P, i, r);
              for (var M = d + 1, I = A(d); I >= M; M++)
                if (((y = o(M, n, i, r)), y !== !1)) {
                  l(d, M), (d = M);
                  break;
                }
        ...
        if (
          ...
          if (O) {
            if (O.refreshFromBuffer) {
              ...
              _(F === !0 ? F : F.start, F.end, O.buffer), p(!0), (y = O);
            }
          } else p(!0), (f().validPositions = e.extend(!0, {}, x)), (y = !1);
        }
        return y;
      }
      function E(e, t) {
        var n;
        if (
          (t ? ((n = v(e).match), "" == n.def && (n = y(e))) : (n = y(e)),
          null != n.fn)
        )
          return n.fn;
        if (
      ...
      function D() {
        ...
        for (
          ...
          (i = v(t, r, t - 1)), (r = i.locator.slice());
        var o = y(t - 1);
        return (e = "" !== o.def ? t : t - 1), void 0 === fe || fe > e ? e : fe;
      }
      function A(e, t) {
        var n = D();
        if (e >= n) return n;
        for (
          var i = e;
          ++i < n &&
          ((t === !0 && (y(i).newBlockMarker !== !0 || !E(i))) ||
            (t !== !0 &&
              !E(i) &&
              (a.nojumps !== !0 || a.nojumpsThreshold > i)));
      ...
      function P(e, t) {
        ...
        for (
          ;
          --n > 0 &&
          ((t === !0 && y(n).newBlockMarker !== !0) || (t !== !0 && !E(n)));

        );
        return n;
      }
      function N(e) {
        return void 0 === f().validPositions[e]
          ? B(e)
          : f().validPositions[e].input;
      }
        ...
        if (r && e.isFunction(a.onBeforeWrite)) {
          ...
          if (s) {
            if (s.refreshFromBuffer) {
              ...
              _(l === !0 ? l : l.start, l.end, s.buffer || n), (n = C(!0));
            }
          ...
          if (e > -1 && !a.keepStatic && void 0 === f().validPositions[e]) {
            ...
            if (i.length > 2)
              for (var o = 0; o < i.length; o++)
                if (
                  i[o].match.optionality !== !0 &&
                  i[o].match.optionalQuantifier !== !0 &&
                  (null === i[o].match.fn ||
                    void 0 === n ||
                    i[o].match.fn.test(n.match.def, f(), e, !0, a) !== !1) &&
                  (r++, null === i[o].match.fn && (n = i[o]), r > 1)
                )
      ...
      function I(n, i, r, o) {
        function s() {
          ...
          if (-1 !== t && !E(u)) {
            e = !0;
            for (var n = w().slice(u, u + t), i = 0; i < n.length; i++)
              if (" " !== n[i]) {
                e = !1;
                break;
              }
        ...
        e.each(l, function (t, i) {
          if (void 0 !== i) {
            ...
            if (!s() || r || a.autoUnmask) {
              var m = r
                ? t
                : null == p.match.fn && p.match.optionality && l + 1 < f().p
                ? l + 1
                : f().p;
              G.call(n, o, !0, !1, r, m), (u = m + 1), (c = "");
          ...
          i &&
            M(
              n,
              C(),
              document.activeElement === n ? A(h(0)) : void 0,
              new e.Event("checkval")
            );
      }
      function O(t) {
          ...
          return (
            e.setSelectionRange
              ...
              ? ((o = window.getSelection().getRangeAt(0)),
                (o.commonAncestorContainer.parentNode === e ||
      ...
      function R(t) {
        ...
        for (
          ...
          (i.match.optionality ||
            ...
            (u &&
              ((u !== s[n].locator[l.alternation] && null != i.match.fn) ||
                (null === i.match.fn &&
                  i.locator[l.alternation] &&
                  T(
                    i.locator[l.alternation].toString().split(","),
                    u.toString().split(",")
                  ) &&
                  "" !== k(n)[0].def)))) &&
            r[n] === B(n, i.match));
      ...
      function q(e, t) {
        return he
          ? e - t > 1 || (e - t === 1 && a.insertMode)
          : t - e > 1 || (t - e === 1 && a.insertMode);
      }
      function W(t) {
        function n(t) {
          if (
        ...
        function i() {
          return this.inputmask
            ? this.inputmask.opts.autoUnmask
              ...
              : s.call(this) !== w().join("")
              ? document.activeElement === this && a.clearMaskOnLostFocus
                ? (he ? H(C().slice()).reverse() : H(C().slice())).join("")
                : s.call(this)
              : ""
            : s.call(this);
        }
        ...
        t.inputmask.__valueGet ||
          (Object.getOwnPropertyDescriptor && void 0 === t.value
            ? ((s = function () {
              ...
              Object.defineProperty(t, "value", { get: i, set: r }))
      ...
      function $(n, i, r, o) {
        function s() {
          if (a.keepStatic) {
            ...
            var t,
              i = [],
              r = e.extend(!0, {}, f().validPositions);
            for (t = h(); t >= 0; t--) {
              var o = f().validPositions[t];
              if (
                o &&
                (null != o.match.fn && i.push(o.input),
                delete f().validPositions[t],
                void 0 !== o.alternation &&
                  o.locator[o.alternation] === v(t).locator[o.alternation])
              )
                break;
            }
            if (t > -1)
            ...
            else f().validPositions = e.extend(!0, {}, r);
          }
        }
        if (
          (a.numericInput || he) &&
        ...
        i === t.keyCode.BACKSPACE &&
        (r.end - r.begin < 1 || a.insertMode === !1)
          ? ((r.begin = P(r.begin)),
            void 0 === f().validPositions[r.begin] ||
              (f().validPositions[r.begin].input !== a.groupSeparator &&
                f().validPositions[r.begin].input !== a.radixPoint) ||
              r.begin--)
          : i === t.keyCode.DELETE &&
            r.begin === r.end &&
            ((r.end = E(r.end) ? r.end + 1 : A(r.end) + 1),
            void 0 === f().validPositions[r.begin] ||
              (f().validPositions[r.begin].input !== a.groupSeparator &&
                f().validPositions[r.begin].input !== a.radixPoint) ||
              r.end++),
      ...
      function z(i) {
        ...
        if (
          ...
          (s === t.keyCode.HOME && !i.shiftKey) || s === t.keyCode.PAGE_UP
            ? (i.preventDefault(), F(r, 0, i.shiftKey ? l.begin : 0, !0))
            : ((a.undoOnEscape && s === t.keyCode.ESCAPE) ||
                (90 === s && i.ctrlKey)) &&
              i.altKey !== !0
            ? (I(r, !0, !1, le.split("")), o.trigger("click"))
            : s !== t.keyCode.INSERT || i.shiftKey || i.ctrlKey
            ? a.tabThrough === !0 && s === t.keyCode.TAB
              ? (i.shiftKey === !0
                  ? (null === y(l.begin).fn && (l.begin = A(l.begin)),
                    (l.end = P(l.begin, !0)),
                    (l.begin = P(l.end, !0)))
                  : ((l.begin = A(l.begin, !0)),
                    (l.end = A(l.begin, !0)),
                    l.end < D() && l.end--),
                l.begin < D() && (i.preventDefault(), F(r, l.begin, l.end)))
              : a.insertMode !== !1 ||
                i.shiftKey ||
                (s === t.keyCode.RIGHT
                  ? setTimeout(function () {
            ...
            : ((a.insertMode = !a.insertMode),
              F(r, a.insertMode || l.begin !== D() ? l.begin : l.begin - 1));
      ...
      function G(n, i, r, o, s) {
        ...
        if (
          !(i === !0 || (n.ctrlKey && n.altKey)) &&
          (n.ctrlKey || n.metaKey || ve)
        )
          return (
            u === t.keyCode.ENTER &&
              le !== C().join("") &&
        ...
        if (u) {
          ...
          var d,
            h = i ? { begin: s, end: s } : F(l),
            g = String.fromCharCode(u),
            v = q(h.begin, h.end);
          v &&
            ((f().undoPositions = e.extend(!0, {}, f().validPositions)),
            $(l, t.keyCode.DELETE, h, !0),
            (h.begin = f().p),
            a.insertMode ||
              ((a.insertMode = !a.insertMode),
              m(h.begin, o),
          ...
          if (x !== !1) {
            if (
              ...
              d =
                !a.keepStatic &&
                ((void 0 !== b[y + 1] &&
                  k(y + 1, b[y].locator.slice(), y).length > 1) ||
                  void 0 !== b[y].alternation)
                  ? y + 1
                  : A(y);
            }
            f().p = d;
          ...
          if (r !== !1) {
            ...
            if (
              ...
              f().writeOutBuffer && x !== !1)
            ) {
              var S = C();
              M(
                l,
                S,
                a.numericInput && void 0 === x.caret ? P(d) : d,
                n,
                i !== !0
              ),
                i !== !0 &&
              ...
              v &&
                ((f().buffer = void 0),
                (f().validPositions = f().undoPositions));
          } else
            v &&
              ((f().buffer = void 0), (f().validPositions = f().undoPositions));
          if (
            (a.showTooltip && (l.title = a.tooltip || f().mask),
            i && e.isFunction(a.onBeforeWrite))
          ) {
        ...
        l === w().slice(0, s.begin).join("") && (l = ""),
          ...
          window.clipboardData && window.clipboardData.getData
            ...
            : i.clipboardData &&
              ...
              (o = l + i.clipboardData.getData("text/plain") + c);
        var u = o;
        if (e.isFunction(a.onBeforePaste)) {
          if (((u = a.onBeforePaste(o, a)), u === !1))
            return t.preventDefault(), !1;
          u || (u = o);
        }
        return (
          I(n, !1, !1, he ? u.split("").reverse() : u.toString().split("")),
          M(n, C(), void 0, t, !0),
          r.trigger("click"),
      ...
      function X(n) {
        ...
        if (C().join("") !== r) {
          ...
          if (
            ((r = r.replace(
              new RegExp("(" + t.escapeRegex(w().join("")) + ")*"),
              ""
            )),
            u)
          ) {
            ...
            if (1 === a.length) {
              ...
              return (
                ...
                G.call(
                  ...
                  !0,
                  !1,
                  f().validPositions[o.begin - 1] ? o.begin : o.begin - 1
                ),
                !1
              );
            }
          ...
          if (
            (o.begin > r.length && (F(i, r.length), (o = F(i))),
            C().length - r.length !== 1 ||
              r.charAt(o.begin) === C()[o.begin] ||
              r.charAt(o.begin + 1) === C()[o.begin] ||
              E(o.begin))
          ) {
            for (
              var l = h() + 1, c = C().slice(l).join("");
              null === r.match(t.escapeRegex(c) + "$");
          ...
          } else (n.keyCode = t.keyCode.BACKSPACE), z.call(i, n);
          n.preventDefault();
        }
      }
      function Q(e) {
        var t = e.originalEvent || e;
        (le = C().join("")), "" === ce || 0 !== t.data.indexOf(ce);
      }
      function V(t) {
        var n = this,
          i = t.originalEvent || t,
      ...
      function K(t) {
        ...
        I(
          ...
          !0,
          !1,
          (e.isFunction(a.onBeforeMask) ? a.onBeforeMask(i, a) || i : i).split(
            ""
          )
        ),
          (le = C().join("")),
      ...
      function J(e) {
        ...
        a.showMaskOnFocus &&
        (!a.showMaskOnHover || (a.showMaskOnHover && "" === n))
          ? t.inputmask._valueGet() !== C().join("") && M(t, C(), A(h()))
          : ye === !1 && F(t, A(h())),
          a.positionCaretOnTab === !0 &&
            setTimeout(function () {
              F(t, A(h()));
            }, 0),
          (le = C().join(""));
      ...
      function Z(e) {
        var t = this;
        if (
          ((ye = !1), a.clearMaskOnLostFocus && document.activeElement !== t)
        ) {
          var n = C().slice(),
            i = t.inputmask._valueGet();
          i !== t.getAttribute("placeholder") &&
            "" !== i &&
            (-1 === h() && i === w().join("") ? (n = []) : H(n), M(t, n));
        }
      }
      function ee(t) {
        function n(t) {
          ...
          if (r.begin === r.end)
            if (n(r.begin))
              F(
                i,
                a.numericInput
                  ? A(e.inArray(a.radixPoint, C()))
                  : e.inArray(a.radixPoint, C())
              );
            else {
              var o = r.begin,
                s = h(o),
          ...
          le !== o.join("") &&
            ...
            "" !== r &&
              ...
              L(o) === !1 &&
                ...
                a.clearIncomplete &&
                  (p(), (o = a.clearMaskOnLostFocus ? [] : w().slice()))),
              M(i, o, void 0, t));
        }
      }
      function re(e) {
      ...
      function oe(e) {
        le !== C().join("") && de.trigger("change"),
          a.clearMaskOnLostFocus &&
            -1 === h() &&
            ue.inputmask._valueGet &&
            ue.inputmask._valueGet() === w().join("") &&
            ue.inputmask._valueSet(""),
          a.removeMaskOnSubmit &&
            (ue.inputmask._valueSet(ue.inputmask.unmaskedvalue(), !0),
            setTimeout(function () {
              M(ue, C());
            }, 0));
      }
      ...
      function se(t) {
        if (
          ((ue = t),
          (de = e(ue)),
          a.showTooltip && (ue.title = a.tooltip || f().mask),
          ("rtl" === ue.dir || a.rightAlign) && (ue.style.textAlign = "right"),
          ("rtl" === ue.dir || a.numericInput) &&
            ((ue.dir = "ltr"),
            ue.removeAttribute("dir"),
            (ue.inputmask.isRTL = !0),
            (he = !0)),
          be.off(ue),
          W(ue),
          i(ue, a) &&
            (be.on(ue, "submit", oe),
            be.on(ue, "reset", ae),
            be.on(ue, "mouseenter", re),
            be.on(ue, "blur", ie),
            be.on(ue, "focus", J),
            be.on(ue, "mouseleave", Z),
            be.on(ue, "click", ee),
            be.on(ue, "dblclick", te),
            be.on(ue, "paste", U),
            be.on(ue, "dragdrop", U),
            be.on(ue, "drop", U),
            be.on(ue, "cut", ne),
            be.on(ue, "complete", a.oncomplete),
            be.on(ue, "incomplete", a.onincomplete),
            be.on(ue, "cleared", a.oncleared),
            be.on(ue, "keydown", z),
            be.on(ue, "keypress", G),
            be.on(ue, "input", X),
            c ||
              (be.on(ue, "compositionstart", Q),
              be.on(ue, "compositionupdate", V),
              be.on(ue, "compositionend", Y))),
          be.on(ue, "setvalue", K),
          "" !== ue.inputmask._valueGet() || a.clearMaskOnLostFocus === !1)
        ) {
          var n = e.isFunction(a.onBeforeMask)
            ? a.onBeforeMask(ue.inputmask._valueGet(), a) ||
              ue.inputmask._valueGet()
            : ue.inputmask._valueGet();
          I(ue, !0, !1, n.split(""));
          var r = C().slice();
                    ...
                    (this.readOnly &&
                      !(
                        ("keydown" === n.type &&
                          n.ctrlKey &&
                          67 === n.keyCode) ||
                        (a.tabThrough === !1 && n.keyCode === t.keyCode.TAB)
                      ))
                  )
                ) {
                  switch (n.type) {
      ...
      if (void 0 !== r)
        switch (r.action) {
          ...
          case "unmaskedvalue":
            return (
              (ue = r.el),
              void 0 !== ue && void 0 !== ue.inputmask
                ? ((o = ue.inputmask.maskset),
                  (a = ue.inputmask.opts),
                  (he = ue.inputmask.isRTL))
                : ((pe = r.value),
                  a.numericInput && (he = !0),
                  (pe = (e.isFunction(a.onBeforeMask)
                    ? a.onBeforeMask(pe, a) || pe
                    : pe
                  ).split("")),
                  I(void 0, !1, !1, he ? pe.reverse() : pe),
                  e.isFunction(a.onBeforeWrite) &&
                    a.onBeforeWrite(void 0, C(), 0, a)),
              O(ue)
            );
          case "mask":
            (ue = r.el),
          ...
          case "format":
            return (
              a.numericInput && (he = !0),
              (pe = (e.isFunction(a.onBeforeMask)
                ? a.onBeforeMask(r.value, a) || r.value
                : r.value
              ).split("")),
              I(void 0, !1, !1, he ? pe.reverse() : pe),
              e.isFunction(a.onBeforeWrite) &&
              ...
              r.metadata
                ? {
                    ...
                    metadata: s({ action: "getmetadata" }, o, a),
                  }
                : he
          ...
          case "isValid":
            a.numericInput && (he = !0),
              r.value
                ? ((pe = r.value.split("")),
                  I(void 0, !1, !0, he ? pe.reverse() : pe))
                : (r.value = C().join(""));
            for (
              var ke = C(), we = R(), Ce = ke.length - 1;
              Ce > we && !E(Ce);
              Ce--
            );
            return (
              ke.splice(we, Ce + 1 - we), L(ke) && r.value === C().join("")
            );
          case "getemptymask":
            return w();
          case "remove":
            ...
            Object.getOwnPropertyDescriptor &&
              (_e = Object.getOwnPropertyDescriptor(ue, "value")),
              _e && _e.get
                ? ue.inputmask.__valueGet &&
                  Object.defineProperty(ue, "value", {
                    get: ue.inputmask.__valueGet,
                    set: ue.inputmask.__valueSet,
                  })
                : document.__lookupGetter__ &&
                  ue.__lookupGetter__("value") &&
                  ue.inputmask.__valueGet &&
                  (ue.__defineGetter__("value", ue.inputmask.__valueGet),
                  ue.__defineSetter__("value", ue.inputmask.__valueSet)),
              (ue.inputmask = void 0);
            break;
          case "getmetadata":
            if (e.isArray(o.metadata)) {
              for (var Se, Te = h(), je = Te; je >= 0; je--)
                if (
                  f().validPositions[je] &&
                  void 0 !== f().validPositions[je].alternation
                ) {
                  Se = f().validPositions[je].alternation;
                  break;
                }
              return void 0 !== Se
                ? o.metadata[f().validPositions[Te].locator[Se]]
                : o.metadata[0];
            }
            return o.metadata;
        }
    ...
    (t.prototype = {
      ...
      mask: function (n) {
        ...
        return (
          "string" == typeof n &&
            (n = document.getElementById(n) || document.querySelectorAll(n)),
          (n = n.nodeName ? [n] : n),
          e.each(n, function (n, r) {
            ...
            void 0 !== c &&
              ...
              (r.inputmask = new t()),
              (r.inputmask.opts = l),
              (r.inputmask.noMasksCache = i.noMasksCache),
              (r.inputmask.userOptions = e.extend(!0, {}, i.userOptions)),
              (r.inputmask.el = r),
              (r.inputmask.maskset = c),
              (r.inputmask.isRTL = !1),
      ...
      option: function (t) {
        return "string" == typeof t
          ...
          ? (e.extend(this.opts, t),
            ...
            this.el &&
              (void 0 !== t.mask || void 0 !== t.alias
                ? this.mask(this.el)
                : (e.data(this.el, "_inputmask_opts", this.opts),
                  s({ action: "mask", el: this.el }))),
            this)
          : void 0;
      },
      ...
      t.extendAliases({
        "dd/mm/yyyy": {
          ...
          isInYearRange: function (e, t, n) {
            ...
            return (
              (!isNaN(i) && i >= t && n >= i) || (!isNaN(r) && r >= t && n >= r)
            );
          },
          determinebaseyear: function (e, t, n) {
            ...
            if (i > t) {
              for (
                var r = t.toString().slice(0, 2), o = t.toString().slice(2, 4);
                r + n > t;
              ...
              prevalidator: [
                {
                  validator: function (e, t, n, i, r) {
                    ...
                    return i ||
                      a ||
                      !(a = r.regex.val2(r.separator).test(o + "0" + e))
                      ? a
                ...
                if (o && "24" !== r.hourFormat && r.regex.hrs24.test(e)) {
                  ...
                  return (
                    ...
                    10 > a
                      ...
                      : ((t.buffer[n] = a.toString().charAt(1)),
                        (t.buffer[n - 1] = a.toString().charAt(0))),
                    {
              ...
              prevalidator: [
                {
                  validator: function (e, t, n, i, r) {
                    ...
                    return i || o || !(o = r.regex.ms.test("0" + e))
                      ? o
                      : ((t.buffer[n] = "0"), n++, { pos: n });
                  },
                  cardinality: 1,
        ...
        numeric: {
          mask: function (e) {
            ...
            if (
              ...
              (e.integerDigits =
                parseInt(e.integerDigits) + (0 === i ? n - 1 : n)),
          ...
          postFormat: function (n, i, r, o) {
            o.numericInput === !0 &&
              ((n = n.reverse()),
              isFinite(i) && (i = n.join("").length - i - 1));
            var a,
              s,
              l = !1;
            n.length >= o.suffix.length &&
              n.join("").indexOf(o.suffix) === n.length - o.suffix.length &&
              ((n.length = n.length - o.suffix.length), (l = !0)),
              (i =
                i >= n.length
                  ? n.length - 1
                  : i < o.prefix.length
            ...
            if (
              "" === o.groupSeparator ||
              (o.numericInput !== !0 &&
                -1 !== e.inArray(o.radixPoint, n) &&
                i > e.inArray(o.radixPoint, n)) ||
              new RegExp(
                "[" + t.escapeRegex(o.negationSymbol.front) + "+]"
              ).test(u)
            ) {
              if (l)
                for (a = 0, s = o.suffix.length; s > a; a++)
                  n.push(o.suffix.charAt(a));
              return { pos: i };
            }
            var d = n.slice();
            ...
            var f = d.join(""),
              p = f;
            if (
              (f.length > 0 && o.autoGroup) ||
              (r && -1 !== f.indexOf(o.groupSeparator))
            ) {
              ...
              if (
                ((f = "" === o.radixPoint ? f : m[0]),
                f !== o.prefix + "?0" &&
                  f.length >= o.groupSize + o.prefix.length)
              )
                for (
                  var g = new RegExp(
                    "([-+]?[\\d?]+)([\\d?]{" + o.groupSize + "})"
                  ...
                  (f = f.replace(g, "$1" + o.groupSeparator + "$2")),
                    (f = f.replace(
                      o.groupSeparator + o.groupSeparator,
                      o.groupSeparator
                    ));
              "" !== o.radixPoint && m.length > 1 && (f += o.radixPoint + m[1]);
            }
            for (
              c = p !== f, n.length = f.length, a = 0, s = f.length;
              s > a;
              a++
            )
              n[a] = f.charAt(a);
            ...
            if (
              (-1 === v &&
                u === o.radixPoint &&
                (v = e.inArray(o.radixPoint, n)),
              r ? (n[v] = u) : n.splice(v, 1),
              !c && l)
            )
              for (a = 0, s = o.suffix.length; s > a; a++)
                n.push(o.suffix.charAt(a));
            return (
              (v =
                o.numericInput && isFinite(i) ? n.join("").length - v - 1 : v),
              o.numericInput &&
                ((n = n.reverse()),
                e.inArray(o.radixPoint, n) < v &&
                  n.join("").length - o.suffix.length !== v &&
                  (v -= 1)),
              { pos: v, refreshFromBuffer: c, buffer: n }
            );
          },
          onBeforeWrite: function (n, i, r, o) {
            if (n && ("blur" === n.type || "checkval" === n.type)) {
              ...
              if (
                ((s = s.replace(o.suffix, "")),
                (s = s.replace(
                  new RegExp(t.escapeRegex(o.groupSeparator), "g"),
                  ""
                )),
                "," === o.radixPoint &&
                  (s = s.replace(t.escapeRegex(o.radixPoint), ".")),
                isFinite(s) &&
                  isFinite(o.min) &&
                  parseFloat(s) < parseFloat(o.min))
              )
                return e.extend(
                  !0,
                  {
              ...
              if (o.numericInput !== !0) {
                var l =
                    "" !== o.radixPoint
                      ? i.join("").split(o.radixPoint)
                      : [i.join("")],
                  c = l[0].match(o.regex.integerPart(o)),
                  u =
                    2 === l.length
                      ? l[1].match(o.regex.integerNPart(o))
                      : void 0;
                if (c) {
                  (c[0] !== o.negationSymbol.front + "0" &&
                    c[0] !== o.negationSymbol.front &&
                    "+" !== c[0]) ||
                    (void 0 !== u && !u[0].match(/^0+$/)) ||
                    i.splice(c.index, 1);
                  var d = e.inArray(o.radixPoint, i);
                  if (-1 !== d) {
                    if (isFinite(o.digits) && !o.digitsOptional) {
                      for (var f = 1; f <= o.digits; f++)
                        (void 0 === i[d + f] ||
                          i[d + f] === o.placeholder.charAt(0)) &&
                          (i[d + f] = "0");
                      return { refreshFromBuffer: a !== i.join(""), buffer: i };
                    }
                    if (d === i.length - o.suffix.length - 1)
                      return (
                        i.splice(d, 1), { refreshFromBuffer: !0, buffer: i }
                      );
                  }
                }
              }
            ...
            if (o.autoGroup) {
              ...
              return (p.caret = r <= o.prefix.length ? p.pos : p.pos + 1), p;
            }
          },
          regex: {
            ...
            integerNPart: function (e) {
              return new RegExp(
                "[\\d" + t.escapeRegex(e.groupSeparator) + "]+"
              );
            },
          },
                ...
                return t.buffer[o.index] ===
                  ...
                  ? "-" === e
                    ...
                    ? {
                        ...
                        remove: [
                          o.index,
                          t.buffer.length - r.suffix.length - 1,
                        ],
                        caret: n,
                      }
                  ...
                  ? "" !== r.negationSymbol.back
                    ...
                    : { pos: o.index, c: r.negationSymbol.front, caret: n + 1 }
          ...
          radixHandler: function (t, n, i, r, o) {
            if (
              ...
              if (-1 !== a && n.validPositions[a])
                return n.validPositions[a - 1]
                  ? { caret: a + 1 }
                  : { pos: s.index, c: s[0], caret: a + 1 };
              if (!s || ("0" === s[0] && s.index + 1 !== i))
                return (
                  (n.buffer[s ? s.index : i] = "0"),
          ...
          leadingZeroHandler: function (t, n, i, r, o) {
            if (o.numericInput === !0) {
              if ("0" === n.buffer[n.buffer.length - o.prefix.length - 1])
                return {
                  pos: i,
              ...
              if (a && !r && (-1 === s || s >= i))
                if (0 === a[0].indexOf("0")) {
                  ...
                  var l = e.inArray(o.radixPoint, n._buffer),
                    c =
                      (n._buffer &&
                        n.buffer.slice(s).join("") ===
                          n._buffer.slice(l).join("")) ||
                      0 === parseInt(n.buffer.slice(s + 1).join("")),
                    u =
                      (n._buffer &&
                        n.buffer.slice(a.index, s).join("") ===
                          n._buffer.slice(o.prefix.length, l).join("")) ||
                      "0" === n.buffer.slice(a.index, s).join("");
                  if (-1 === s || (c && u))
                    return (
                      n.buffer.splice(a.index, 1),
                      (i = i > a.index ? i - 1 : a.index),
                      { pos: i, remove: a.index }
                    );
                  if (a.index + 1 === i || "0" === t)
                    return (
                      n.buffer.splice(a.index, 1),
          ...
          postValidation: function (e, n, i) {
            ...
            return (
              ...
              isFinite(a) &&
                (null !== i.max &&
                  isFinite(i.max) &&
                  ((a = parseFloat(a) > parseFloat(i.max) ? i.max : a),
                  (r = i.postFormat((i.prefix + a).split(""), 0, !0, i))),
                null !== i.min &&
                  isFinite(i.min) &&
                  ((a = parseFloat(a) < parseFloat(i.min) ? i.min : a),
                  (r = i.postFormat((i.prefix + a).split(""), 0, !0, i)))),
              r
            );
          },
          definitions: {
            "~": {
              validator: function (n, i, r, o, a) {
                ...
                if (
                  !s &&
                  ((s = a.radixHandler(n, i, r, o, a)),
                  !s &&
                    ((s = o
                      ? new RegExp(
                          "[0-9" + t.escapeRegex(a.groupSeparator) + "]"
                        ).test(n)
                      : new RegExp("[0-9]").test(n)),
                    s === !0 &&
                      ((s = a.leadingZeroHandler(n, i, r, o, a)), s === !0)))
                ) {
            ...
            "+": {
              validator: function (e, t, n, i, r) {
                ...
                return (
                  !o &&
                    ((i && r.allowMinus && e === r.negationSymbol.front) ||
                      (r.allowMinus && "-" === e) ||
                      (r.allowPlus && "+" === e)) &&
                    (o =
                      "-" !== e ||
          ...
          isComplete: function (e, n) {
            ...
            return (
              (o = o.replace(n.suffix, "")),
              (o = o.replace(
                new RegExp(t.escapeRegex(n.groupSeparator), "g"),
                ""
              )),
              "," === n.radixPoint &&
                (o = o.replace(t.escapeRegex(n.radixPoint), ".")),
              isFinite(o)
            );
          },
          onBeforeMask: function (e, n) {
            if ("" !== n.radixPoint && isFinite(e))
          ...
          canClearPosition: function (n, i, r, o, a) {
            var s = n.validPositions[i].input,
              l =
                s !== a.radixPoint ||
                (null !== n.validPositions[i].match.fn &&
                  a.decimalProtect === !1) ||
                isFinite(s) ||
                i === r ||
                s === a.groupSeparator ||
                s === a.negationSymbol.front ||
                s === a.negationSymbol.back;
            if (l && isFinite(s)) {
              var c,
                u = e.inArray(a.radixPoint, n.buffer),
                d = !1;
              if (
                (void 0 === n.validPositions[u] &&
                  ((n.validPositions[u] = { input: a.radixPoint }), (d = !0)),
                !o && n.buffer)
              ) {
                c = n.buffer
                  .join("")
                ...
                if (p)
                  for (
                    ;
                    n.validPositions[f] &&
                    (n.validPositions[f].input === a.groupSeparator ||
                      "0" === n.validPositions[f].input);

                  )
                    delete n.validPositions[f], f++;
              }
              var h = [];
              for (var m in n.validPositions)
                void 0 !== n.validPositions[m].input &&
                  h.push(n.validPositions[m].input);
              if ((d && delete n.validPositions[u], u > 0)) {
                var g = h.join("");
                if ((c = g.match(a.regex.integerNPart(a))))
                  if (u >= i)
                    if (0 === c[0].indexOf("0"))
                      l = c.index !== i || "0" === a.placeholder;
                    else {
                      var v = parseInt(
                          c[0].replace(
                            new RegExp(t.escapeRegex(a.groupSeparator), "g"),
                      ...
                      10 > v &&
                        n.validPositions[i] &&
                        ("0" !== a.placeholder || y > 0) &&
                        ((n.validPositions[i].input = "0"),
                        (n.p = a.prefix.length + 1),
                        (l = !1));
                    }
                  else
                    0 === c[0].indexOf("0") &&
              ...
              validator: function (t, n, i, r, o) {
                ...
                function s() {
                  var e,
                    ...
                    n = new a(),
                    i = [];
                  for (o.regexTokens = []; (e = o.tokenizer.exec(o.regex)); )
                        ...
                        var s = t.split(","),
                          ...
                          c =
                            1 === s.length
                              ...
                              : parseInt(s[1]);
                        if (
                          ((r.quantifier = { min: l, max: c }), i.length > 0)
                        ) {
                          var d = i[i.length - 1].matches;
                          (e = d.pop()),
                            e.isGroup ||
                              ((u = new a(!0)), u.matches.push(e), (e = u)),
                            d.push(e),
                            d.push(r);
                        } else
                          (e = n.matches.pop()),
                    ...
                    if (o.isGroup === !0) i = l(o, !0);
                      ...
                      if (isNaN(o.quantifier.max)) {
                        for (
                          ...
                          o.repeaterPart &&
                          o.repeaterPart !== f &&
                          o.repeaterPart.length > f.length &&
                          !(i = l(s, !0));
  ...
  (function (e, t) {
    ...
    function c(t) {
      function i(t) {
        function i(e) {
          (e += c), (a = u[e] = u[e] || n(a, x[a.parent.key + c] || a.parent));
        }
        var r,
          o,
          a,
        ...
        if ((s = t.getAttribute(v))) {
          ...
          r !== s &&
            ((l = l.parentNode
              ...
              : 0),
            (a = x[s]) ||
              ((a = b[s]), (a = n(a, x[l] || b[l])), (a.key = ++w), (x[w] = a)),
            C && i(s)),
            t.removeAttribute(v);
        } else
          C &&
            ...
            (i(a.key),
            (x[a.key] = a),
            (l = e.data(t.parentNode, "tmplItem")),
            (l = l ? l.key : 0));
        if (a) {
          for (o = a; o && o.key != l; ) o.nodes.push(t), (o = o.parent);
      ...
      for (a = 0, s = t.length; a < s; a++)
        if (1 === (r = t[a]).nodeType) {
          for (o = r.getElementsByTagName("*"), l = o.length - 1; l >= 0; l--)
            i(o[l]);
          i(r);
        }
    }
    function u(e, t, n, i) {
      return e
        ? void _.push({ _: e, tmpl: t, item: this, data: n, options: i })
        : _.pop();
    }
    function d(t, n, i) {
      ...
      e.fn.extend({
        ...
        domManip: function (t, n, i, r) {
          if (t[0] && e.isArray(t[0])) {
            for (
              var o, a = e.makeArray(arguments), s = t[0], l = s.length, c = 0;
              c < l && !(o = e.data(s[c++], "tmplItem"));
          ...
          return (C = 0), m || e.tmpl.complete(x), this;
        },
      }),
      e.extend({
        tmpl: function (t, r, o, s) {
          var l,
            c = !s;
          if (c) (s = k), (t = e.template[t] || e.template(null, t)), (b = {});
          else if (!t)
            return (
              (t = s.tmpl),
              (x[s.key] = s),
        ...
        template: function (t, n) {
          return n
            ? ("string" == typeof n
              ...
              n.nodeType &&
                (n = e.data(n, "tmpl") || e.data(n, "tmpl", o(n.innerHTML))),
    ...
    supportedCSS &&
        ...
        getRotateAngle: function () {
          for (var e = [], t = 0, n = this.length; t < n; t++) {
            ...
            i.Wilq32 &&
              ...
              (e[t] = i.Wilq32.PhotoEffect._angle);
          }
          return e;
        },
        stopRotate: function () {
          for (var e = 0, t = this.length; e < t; e++) {
            var n = this.get(e);
            n.Wilq32 &&
              n.Wilq32.PhotoEffect &&
              clearTimeout(n.Wilq32.PhotoEffect._timer);
          }
        },
      }),
      ...
      (Wilq32.PhotoEffect.prototype = {
        _setupParameters: function (e) {
          (this._parameters = this._parameters || {}),
            ...
            (this._parameters.animateTo =
              "number" == typeof e.animateTo ? e.animateTo : this._angle),
            (this._parameters.step = e.step || this._parameters.step || null),
            (this._parameters.easing =
              e.easing || this._parameters.easing || this._defaultEasing),
            (this._parameters.duration =
              e.duration || this._parameters.duration || 1e3),
            (this._parameters.callback =
              e.callback || this._parameters.callback || this._emptyFunction),
            (this._parameters.center = e.center ||
            ...
            e.bind &&
              e.bind != this._parameters.bind &&
              this._BindEvents(e.bind);
        },
        ...
        _handleRotation: function (e, t) {
          return supportedCSS || this._img.complete || t
            ? (this._setupParameters(e),
              void (this._angle == this._parameters.animateTo
                ? this._rotate(this._angle)
                : this._animateStart()))
            : void this._onLoadDelegate.push(e);
        },
        _BindEvents: function (e) {
          if (e && this._eventObj) {
            if (this._parameters.bind) {
              ...
              for (var n in t)
                t.hasOwnProperty(n) && jQuery(this._eventObj).unbind(n, t[n]);
            }
            this._parameters.bind = e;
            for (var n in e)
              e.hasOwnProperty(n) && jQuery(this._eventObj).bind(n, e[n]);
          }
        },
        _Loader: (function () {
          return IE
            ? function () {
                ...
                for (var n; (n = this._onLoadDelegate.shift()); )
                  this._handleRotation(n, !0);
              }
            : function () {
                ...
                for (var t; (t = this._onLoadDelegate.shift()); )
  ...
  (function (e, t, n, i) {
    var r = "beforeInit",
      ...
      a = function (e, t, i) {
        ...
        if (
          (e.superClass &&
            e.superClass.defConfig &&
            (e.defConfig = n.extend({}, e.superClass.defConfig, e.defConfig)),
          (i = t.defConfig = n.extend({}, e.defConfig, i)),
          i.expands && n.extend(t, i.expands),
          e.superClass && e.superClass.call(t, i),
          n.isFunction(e.prototype.init))
        ) {
          var a = t.constructor === e;
          if (
            (a && n.isFunction(i[r]) && i[r].call(t, i),
            e.prototype.init.call(t, i),
            a && n.isFunction(i[o]) && i[o].call(t, i),
            a)
          )
            for (var s = 0, l = t._inits.length; s < l; s++)
              t._inits[s].call(t, t.defConfig);
        }
      },
      s = function (e, t) {
        var i = function (e) {
        ...
        fireEvent: function (e) {
          ...
          if (n[e]) {
            ...
            for (
              var o = 0,
                a = r.length,
                s = { type: e, data: t, stopEvent: i },
                l = [s].concat(Array.prototype.slice.call(arguments, 1)),
                o = 0;
              o < a;
              o++
            )
              if (s._isStop || r[o].apply(t, l) === !1)
                return void (s._isStop = !1);
          }
        },
  ...
  (function (e, t, n, i) {
    ...
    (r.win = n(window)),
      ...
      (r.isIE6 = !(
        ...
        6 != navigator.userAgent.toLowerCase().match(/msie ([\d.]+)/)[1]
      )),
      (r.toViewCenter = function (e) {
        r.toViewCenter.fn(e),
          r.win.bind("resize", function () {
            r.toViewCenter.fn(e);
          });
      }),
      (r.toViewCenter.fn = function (e) {
        ...
        e.css({ left: o / 2 - t / 2 + s, top: a / 2 - i / 2 + l });
      }),
        ...
        return (
          (o = function () {
            ...
            (s = r.win.scrollTop()),
              (c = r.win.scrollLeft()),
              t.stop(),
              t.animate({ top: o / 2 - e / 2 + s }, 50),
              (a = s),
              t.animate({ left: i / 2 - n / 2 + c }, 50),
              (l = c);
          }),
          new e.Timer({ time: i, fn: o })
        );
      }),
      ...
      (r.template = function (e, t) {
        ...
        for (n in r)
          r.hasOwnProperty(n) &&
            ((i = RegExp("<#=" + n + "#>", "g")), (e = e.replace(i, r[n])));
        return e;
      }),
      (r.add = function (e, t) {
        var n,
        ...
        return (
          (r = Math.pow(10, Math.max(n, i))), (o.mul(e, r) + o.mul(t, r)) / r
        );
      }),
  ...
  (function (e, t, n, i, r) {
    var o = {
      ...
      a = { mouseenter: "mouseleave", mouseover: "mouseout" },
      s = function (e) {
        var t = this;
        t.triggers.bind(e.eventType, t, function (n) {
          var i = this;
          l(n),
      ...
      c = function (e) {
        ...
        (t.autoPlayStart = u),
          ...
          e.autoPlayIsHoverStop &&
            (t.triggers.bind("mouseenter", t, f).bind("mouseleave", t, u),
            t.panels.bind("mouseenter", t, f).bind("mouseleave", t, u),
            "mouseenter" != e.eventType && t.triggers.bind(e.eventType, t, f));
      },
      u = function (e) {
        var t = e && e.data ? e.data : this,
          n = !(!e || !e.relatedTarget) && e.relatedTarget;
        (!n || (t.triggers.index(n) == -1 && t.panels.index(n) == -1)) &&
          d.call(t);
      },
      d = function () {
        var e = this,
        ...
        e._autoPlayTimer = setTimeout(function () {
          h.call(e, e._autoPlayGetIndex()), d.call(e);
        }, t.autoPlay);
      },
      f = function (e) {
        var t = e && e.data ? e.data : this;
      ...
      p = function () {
        ...
        return (i = i > n ? 0 : i), (i = i < 0 ? n : i), (e._index = i);
      },
      h = function (e) {
        var t = this,
          n = t.index;
        (e === n && n != r) ||
          ((t.index = n === r ? e : n),
          (t._index = e),
          t.fireEvent("beforeSwitch", t._index),
          t.fireEvent("onSwitch", t._index),
          t.fireEvent("afterSwitch", t._index));
      },
      m = function (e) {
        var t = e.data,
      ...
      y = {
        init: function (e) {
          ...
          (t.par = i(e.par)),
            ...
            (t._cache = { triggers: {}, panels: {} }),
            e.isDefShow &&
              t._inits.push(function (e) {
                var t = this,
                  n = e.isDefRandom
                    ? parseInt(Math.random() * t.length)
                    : e.index,
                  i = e.currClass,
                  r = e.currPanelClass;
            ...
            e.autoPlay &&
              t.length > 1 &&
              (c.call(t, e),
              t._inits.push(function () {
                t.autoPlayStart();
              })),
            e.delay || a[e.eventType]
              ? s.call(t, e)
              : t.triggers.bind(e.eventType, t, _triggersHander),
        ...
        controlTo: function (e) {
          ...
          n.autoPlay &&
            ...
            (t.autoPlayStop(),
            clearTimeout(t._controlCancelAutoPlayTimer),
            (t._controlCancelAutoPlayTimer = setTimeout(function () {
              t.autoPlayStart();
            }, n.controlCancelAutoPlayTime))),
  ...
  (function (e, t, n, i, r) {
    var o = { isDefShow: !1, hoverDelayOut: 0, hoverIsBindPanels: !1 },
      a = function (e) {
        var t = e.data,
          n = t.defConfig;
      ...
      l = {
        init: function (e) {
          ...
          t.triggers.bind("mouseleave", t, n),
            ...
            e.hoverDelayOut &&
              (t.triggers.bind("mouseenter", t, s),
              e.hoverIsBindPanels && t.panels.bind("mouseenter", t, s));
        },
        hideHander: function (e) {
          ...
          if (t.triggers.index(n) == -1 && t.panels.index(n) == -1) {
            try {
              if (
                r.hoverIsBindPanels &&
                (i.contains(t.getTrigger(t.index).get(0), n) ||
                  i.contains(t.getPanel(t.index).get(0), n))
              )
                return;
            } catch (e) {}
            t.hide();
  ...
  (function (e, t, n, i, r) {
    var o = {
        ...
        realDom: "",
        tpl:
          '<div class="choose-model"><div class="choose-list" style="display:none;"><#=loopItems#></div><span class="info"><input data-realvalue="<#=value#>" class="choose-input" disabled="disabled" type="text" value="<#=text#>" /></span><i class="icon-chevron-down"></i></div>',
        numTpl:
          '<div class="choose-model"><i class="icon-minus no_selection num-mins"></i><div class="choose-list" style="display:none;"><#=loopItems#></div><span class="info"><input data-realvalue="<#=value#>" class="choose-input" disabled="disabled" type="text" value="<#=text#>" /></span><i class="icon-plus no_selection num-plus"></i></div>',
        selectTpl:
          '<div class="choose-model select-list"><div class="choose-list"><#=loopItems#></div><span class="info" style="display:none"><input data-realvalue="<#=value#>" class="choose-input" disabled="disabled" type="text" value="<#=text#>"  /></span></div>',
        itemTpl:
          '<a data-value="<#=value#>" href="javascript:void(0);"><#=text#></a>',
      },
      a = {
        init: function (e) {
          var t = this;
        ...
        defaultBind: function (e) {
          ...
          e.click(function (e) {
            ...
            n.getAttribute("data-value") &&
              t.setValue(n.getAttribute("data-value")),
              t.getListDom().toggle();
          });
        },
        selectBind: function (e) {
          ...
          e.click(function (e) {
            var n = e.target;
            n.getAttribute("data-value") &&
              (i(n).addClass("current").siblings().removeClass("current"),
              t.setValue(n.getAttribute("data-value")));
          });
        },
        numBindEvent: function (t) {
          var n = this;
          t.on("click", ".num-mins", function (t) {
            n.setValue(Number(n.getValue()) - 1),
              t.preventDefault(),
              e.util.clearSelection();
          }),
            t.on("click", ".num-plus", function (t) {
              n.setValue(Number(n.getValue()) + 1),
                t.preventDefault(),
                e.util.clearSelection();
            }),
            t.click(function (e) {
              ...
              t.getAttribute("data-value") &&
                n.setValue(t.getAttribute("data-value")),
                (i(t).hasClass("choose-input") ||
                  t.getAttribute("data-value")) &&
                  n.getListDom().toggle();
            });
        },
        buildSelect: function () {
          for (
            ...
            (d[u] = s
              .replace(/<#=value#>/g, l[u].value)
              .replace(/<#=text#>/g, l[u].text)),
              u == e.getRealDom().selectedIndex &&
                ((f = l[u].value), (p = l[u].text));
          (t = n.isNum ? o : n.isSelectList ? a : r),
            (r = t
              .replace(/<#=text#>/g, p)
              .replace(/<#=loopItems#>/g, d.join(""))),
            (e.dom = i(r)),
            e.dom.addClass(n.cls),
            e.dom.insertBefore(e.getRealDom()),
            n.isNum
              ? (e.numBindEvent(e.dom),
                e.getInput().removeAttr("disabled"),
                e.inputEvent(),
                e.bindEvent())
              : n.isInput
              ? (e.defaultBind(e.dom),
              ...
              ? (e.selectBind(e.dom),
                e.dom
                  .find('.choose-list a[data-value="' + f + '"]')
                  .addClass("current"))
              : (e
                  .getInput()
                  .removeAttr("disabled")
        ...
        getValue: function () {
          var e = this,
            t = e.getRealDom(),
            n = t.selectedIndex;
          return e.defConfig.isInput || e.defConfig.isNum
            ? e.getInput().attr("data-realvalue")
            : t.options[n]
            ? t.options[n].value
            : r;
        },
        ...
        reset: function () {
          var e = this;
          e.dom.remove(), (e.dom = null), (e.listDom = null);
        },
        show: function () {
          this.dom.show();
        },
    ...
    var a = {
        ...
        _countFun: function (e) {
          ...
          this.timeFun = setInterval(function () {
            if (
              ((t = r || parseInt((s - a) / 1e3)),
              null == r && (r = t),
              countNum++,
              (i.allSecond = t),
              (i.w = parseInt(t / 3600 / 24 / 7)),
              (i.d = parseInt(t / 3600 / 24)),
              (i.h = parseInt((t / 3600) % 24)),
              (i.m = parseInt((t / 60) % 60)),
              (i.s = 0 == r ? r : parseInt(t % 60)),
              n.doFixedEvents(countNum),
              n._showTime(i),
              n.defConfig.isRedress &&
                countNum % n.getRedressTime() == 0 &&
                r > n.getRedressTime() &&
                n.redRessTime(),
              0 == r)
            )
              return (
                n.timeload && n.timeload.abort(),
                n._endCount(),
                void n.fireEvent("afterTimeFinish")
              );
            var e = o
              ? document.getElementById("countdownSoundForIE8")
              : document.getElementById("countdownSound");
            "on" == $.cookie("knell") && $("#toogle_bell").hasClass("bell_on")
              ? 0 == i.h && 0 == i.m && i.s < 6 && e.play()
        ...
        redRessTime: function () {
          ...
          t.timeload && t.timeload.abort(),
            (t.timeload = $.ajax({
              url: t.getRedressUrl(),
              data: { curmid: e.Games.getCurrentGame().getCurrentMid() },
              cache: !1,
              type: "GET",
              dataType: "json",
            })
              .done(function (e) {
                1 == Number(e.isSuccess) &&
                  (t.stopCount(),
                  t.setStartTime(
                    new Date(e.nowTime).getTime() + (new Date().getTime() - n)
                  ),
                  t.continueCount(),
                  t.fireEvent("afterSuccessRedRessTime", e));
              })
              .fail(function () {})
              .always(function () {
                t.timeload = null;
        ...
        doFixedEvents: function (e) {
          var t = this,
            n = 0;
          if (0 != fixedEvents.length)
            for (; n < fixedEvents.length; n++)
              e == fixedEvents[n][0] &&
                (fixedEvents[n][1].call(t), fixedEvents.splice(n, 1));
        },
        _showTime: function (e) {
          var t = $(this.defConfig.showDom),
            ...
            o = t.find(".min"),
            a = t.find(".sec");
          n.text(e.w), i.text(e.d), r.text(e.h), o.text(e.m), a.text(e.s);
        },
        checkNum: function (e) {
          return e < 10 ? "0" + e : e;
        },
        ...
        stopCount: function () {
          clearInterval(this.timeFun), (this.timeFun = null);
        },
  ...
  (function (e, t, n, i, r) {
    var o = { time: 500, isNew: !1, fn: function () {} },
      a = [],
      s = {
        init: function (e) {
          var t = this;
        ...
        stop: function () {
          var e = this;
          e.remove(), clearTimeout(e._timer);
        },
      },
      l = e.Class(s, n);
    (l.defConfig = o),
      (e[t] = function (e) {
        ...
        if (e && e.time && e.fn) {
          for (; n < t; n++)
            if (a[n].time == e.time) return a[n].add(e.fn), a[n];
          return new l(e);
        }
      });
    ...
    var o,
      ...
      l = {
        init: function (e) {
          var t = this;
          (t.dom = i(
            '<div class="j-ui-mask" style="display:none;position:absolute;left:0;top:0;"></div>'
          )
            .appendTo("body")
            .css({
              opacity: e.opacity,
        ...
        show: function () {
          var e = this,
            t = s.width(),
            n = s.height();
          e.dom.css({ width: t, height: n }), this.effectShow();
        },
        hide: function () {
          this.effectHide(), this.fireEvent("afterHide");
        },
        css: function (e) {
          this.dom.css(e);
        },
  ...
  (function (e, t, n, i, r) {
    var o,
      ...
      s = {
        ...
        effectShow: function () {
          var e = this;
          a.toViewCenter(e.dom), this.dom.show();
        },
        effectHide: function () {
          this.dom.hide();
        },
        ...
        (i(document),
        {
          init: function (e) {
            ...
            (n = a.isIE6 ? "absolute" : n),
              (t.dom = i(
                '<div class="j-ui-miniwindow ' +
                  e.cls +
                  '" style="z-index:' +
                  e.zIndex +
                  ";position:" +
                  n +
                  ';display:none;"><div class="hd"><i class="close closeBtn"></i><span class="title">提示</span></div><div class="bd_box"><i class="ico-waring" style="display:none"></i><div class="bd"></div></div><a style="display:none" href="javascript:void(0);" class="btn confirm"><span>确 认</span><b class="btn-inner"></b></a><a style="display:none" href="javascript:void(0);" class="btn cancel"><span>取 消</span><b class="btn-inner"></b></a><a href="javascript:void(0);" style="display:none" class="btn closeTip"><span>关 闭</span><b class="btn-inner"></b></a></div>'
              ).appendTo("body")),
              (t.effectShow = e.effectShow),
              (t.effectHide = e.effectHide),
              t.dom.on("click", ".closeBtn", function () {
                t.doNormalClose(), t.hide();
              }),
              t.dom
                .find("." + t.defConfig.confirmButtonText)
                .bind("click", function () {
                  t.doConfirm();
                }),
              t.dom
                .find("." + t.defConfig.cancelButtonText)
                .bind("click", function () {
                  t.doCancel();
                }),
              t.dom
                .find("." + t.defConfig.closeButtonText)
                .bind("click", function () {
                  t.doClose();
                });
          },
          ...
          getConfirmButtonDom: function () {
            ...
            return e
              .getContainerDom()
              .find("." + e.defConfig.confirmButtonText);
          },
          ...
          show: function () {
            ...
            e.fireEvent("beforeShow"),
              ...
              a.isIE6 &&
                e.defConfig.isFixed &&
                (e._IE6Fixed = a.startFixed(e.dom));
          },
          hide: function () {
            var e = this;
            e.effectHide(),
  ...
  (function (e, t, n, i, r) {
    var o,
      ...
      c = {
        init: function (e) {
          ...
          (t.dom = i(
            '<div class="' +
              ...
              l++ +
              ';"><i class="sj sj-t"></i><i class="sj sj-r"></i><i class="sj sj-b"></i><i class="sj sj-l"></i><span class="ui-tip-text">' +
              e.text +
              "</span></div>"
          ).appendTo(i("body"))),
            (t.effectShow = e.effectShow),
        ...
        getTextContainer: function () {
          var e = this;
          return (
            e._textContainer || (e._textContainer = e.dom.find(".ui-tip-text"))
          );
        },
        getDom: function () {
          return this.dom;
        ...
        show: function (e, t, n) {
          ...
          o.dom.css({ left: a.left + e, top: a.top + t }), o.effectShow();
        },
        hide: function () {
          this.effectHide();
        },
    ...
    (u.defConfig = a),
      ...
      (e[t].getInstance = function () {
        return o || (o = new e[t]({ cls: "j-ui-tip-l j-ui-tip-info" }));
      });
...
!(function () {
  ...
  (function (e) {
    ...
    function i(e, t, n, i, r, o, a) {
      return (e = e + (t ^ n ^ i) + r + a), ((e << o) | (e >>> (32 - o))) + t;
    }
    function r(e, t, n, i, r, o, a) {
      return (
        (e = e + (n ^ (t | ~i)) + r + a), ((e << o) | (e >>> (32 - o))) + t
      );
    }
    for (
      var o = CryptoJS,
    ...
    (function (e) {
      ...
      (d.Encryptor = d.extend({
        ...
        (n.BlockCipher = l.extend({
          cfg: l.cfg.extend({ mode: c, padding: d }),
          reset: function () {
            l.reset.call(this);
            var e = this.cfg,
              t = e.iv,
  ...
  (function () {
    ...
    n || LS.setItem("countNum", 12153), (n = n.toString());
    ...
    setInterval(function () {
      ...
      (n = Number(n)), (n += e), (n = n.toString()), LS.setItem("countNum", n);
      for (var i = 0; i < t.size(); i++) {
        var r = t.size() - n.length;
        t.eq(i + r).text(n.substr(i, 1) ? n.substr(i, 1) : 0);
      }
  ...
  (function (e) {
    ...
    function t(t) {
      ...
      if (
        ...
        "wheelDeltaX" in a && (u = a.wheelDeltaX * -1),
        "axis" in a && a.axis === a.HORIZONTAL_AXIS && ((u = d * -1), (d = 0)),
        (c = 0 === d ? u : d),
        "deltaY" in a && ((d = a.deltaY * -1), (c = d)),
        "deltaX" in a && ((u = a.deltaX), 0 === d && (c = u * -1)),
        0 !== d || 0 !== u)
      ) {
        if (1 === a.deltaMode) {
        ...
        return (
          (f = Math.max(Math.abs(d), Math.abs(u))),
  ...
  !(function (e, t) {
    ...
    (e.fn.jScrollPane = function (i) {
      function r(i, r) {
        function o(t) {
          ...
          if (((q = t), W === n))
            (f = i.scrollTop()),
              (p = i.scrollLeft()),
              i.css({ overflow: "hidden", padding: 0 }),
              ($ = i.innerWidth() + xe),
              (z = i.innerHeight()),
              i.width($),
              (W = e('<div class="jspPane" />')
                .css("padding", ye)
                .append(i.children())),
              (G = e('<div class="jspContainer" />')
                .css({ width: $ + "px", height: z + "px" })
                .append(W)
                .appendTo(i));
          else {
            if (
              ...
              (g = q.stickToBottom && E()),
              (v = q.stickToRight && D()),
              (d = i.innerWidth() + xe != $ || i.outerHeight() != z),
              d &&
                (($ = i.innerWidth() + xe),
                (z = i.innerHeight()),
                G.css({ width: $ + "px", height: z + "px" })),
              !d && be == U && W.outerHeight() == X)
            )
              return void i.width($);
            (be = U),
              W.css("width", ""),
          ...
          W.css("overflow", "auto"),
            ...
            K || Y
              ? (i.addClass("jspScrollable"),
                (r = q.maintainPosition && (ee || ie)),
                r && ((s = T()), (c = j())),
                a(),
                l(),
                u(),
                r && (_(v ? U - $ : s, !1), C(g ? X - z : c, !1)),
                M(),
                A(),
                H(),
                q.enableKeyboardNavigation && I(),
                q.clickOnTrack && h(),
                F(),
                q.hijackInternalLinks && R())
              : (i.removeClass("jspScrollable"),
                W.css({ top: 0, left: 0, width: G.width() - xe }),
                P(),
                B(),
                O(),
                m()),
            q.autoReinitialise && !ve
              ? (ve = setInterval(function () {
                  o(q);
                }, q.autoReinitialiseDelay))
              : !q.autoReinitialise && ve && clearInterval(ve),
        ...
        function a() {
          Y &&
            ...
            (re = G.find(">.jspVerticalBar")),
            (oe = re.find(">.jspTrack")),
            (J = oe.find(">.jspDrag")),
            q.showArrows &&
              ((ce = e('<a class="jspArrow jspArrowUp" />')
                .bind("mousedown.jsp", f(0, -1))
                .bind("click.jsp", N)),
              (ue = e('<a class="jspArrow jspArrowDown" />')
                .bind("mousedown.jsp", f(0, 1))
                .bind("click.jsp", N)),
              q.arrowScrollOnHover &&
                (ce.bind("mouseover.jsp", f(0, -1, ce)),
                ue.bind("mouseover.jsp", f(0, 1, ue))),
              d(oe, q.verticalArrowPositions, ce, ue)),
            (se = z),
            G.find(
        ...
        function l() {
          K &&
            ...
            (de = G.find(">.jspHorizontalBar")),
            (fe = de.find(">.jspTrack")),
            (te = fe.find(">.jspDrag")),
            q.showArrows &&
              ((me = e('<a class="jspArrow jspArrowLeft" />')
                .bind("mousedown.jsp", f(-1, 0))
                .bind("click.jsp", N)),
              (ge = e('<a class="jspArrow jspArrowRight" />')
                .bind("mousedown.jsp", f(1, 0))
                .bind("click.jsp", N)),
              q.arrowScrollOnHover &&
                (me.bind("mouseover.jsp", f(-1, 0, me)),
                ge.bind("mouseover.jsp", f(1, 0, ge))),
              d(fe, q.horizontalArrowPositions, me, ge)),
            te
              .hover(
                function () {
        ...
        function u() {
          ...
          K && W.width(G.outerWidth() - xe + "px"),
            ...
            K &&
              ((he = Math.ceil((1 / Q) * pe)),
              he > q.horizontalDragMaxWidth
                ? (he = q.horizontalDragMaxWidth)
                : he < q.horizontalDragMinWidth &&
                  (he = q.horizontalDragMinWidth),
              te.width(he + "px"),
              (ne = pe - he),
              b(ie)),
            Y &&
              ((le = Math.ceil((1 / V) * se)),
              le > q.verticalDragMaxHeight
                ? (le = q.verticalDragMaxHeight)
                : le < q.verticalDragMinHeight &&
                  (le = q.verticalDragMinHeight),
              J.height(le + "px"),
              (Z = se - le),
              y(ee));
        ...
        function h() {
          m(),
            Y &&
              oe.bind("mousedown.jsp", function (t) {
                if (
                  t.originalTarget === n ||
                  ...
                  var i,
                    ...
                    l = function () {
                      ...
                      (i = setTimeout(
                        l,
                        s ? q.initialDelay : q.trackClickRepeatFreq
                      )),
                        (s = !1);
                    },
                    c = function () {
            ...
            K &&
              fe.bind("mousedown.jsp", function (t) {
                if (
                  t.originalTarget === n ||
                  t.originalTarget == t.currentTarget
                ) {
        ...
        function m() {
          fe && fe.unbind("mousedown.jsp"), oe && oe.unbind("mousedown.jsp");
        }
        function g() {
          e("html").unbind(
        ...
        function v(e, t) {
          Y &&
            (0 > e ? (e = 0) : e > Z && (e = Z),
            t === n && (t = q.animateScroll),
            t ? ke.animate(J, "top", e, y) : (J.css("top", e), y(e)));
        }
        function y(e) {
          e === n && (e = J.position().top), G.scrollTop(0), (ee = e);
          var t = 0 === ee,
            r = ee == Z,
            o = e / Z,
            a = -o * (X - z);
          (we != t || _e != r) &&
            ((we = t),
            (_e = r),
            i.trigger("jsp-arrow-change", [we, _e, Ce, Se])),
            k(t, r),
            W.css("top", a),
        ...
        function x(e, t) {
          K &&
            (0 > e ? (e = 0) : e > ne && (e = ne),
            t === n && (t = q.animateScroll),
            t ? ke.animate(te, "left", e, b) : (te.css("left", e), b(e)));
        }
        function b(e) {
          e === n && (e = te.position().left), G.scrollTop(0), (ie = e);
          var t = 0 === ie,
            r = ie == ne,
            o = e / ne,
            a = -o * (U - $);
        ...
        function k(e, t) {
          q.showArrows &&
            (ce[e ? "addClass" : "removeClass"]("jspDisabled"),
            ue[t ? "addClass" : "removeClass"]("jspDisabled"));
        }
        function w(e, t) {
          q.showArrows &&
            (me[e ? "addClass" : "removeClass"]("jspDisabled"),
            ge[t ? "addClass" : "removeClass"]("jspDisabled"));
        }
        function C(e, t) {
          var n = e / (X - z);
          v(n * Z, t);
        ...
        function S(t, n, i) {
          ...
          for (
            ...
            if (
              ...
              (h += r.position().left),
              (r = r.offsetParent()),
              /^body|html$/i.test(r[0].nodeName))
            )
              return;
          (s = j()),
            (c = s + z),
            s > p || n
              ? (d = p - q.horizontalGutter)
              : p + o > c && (d = p - z + o + q.horizontalGutter),
            isNaN(d) || C(d, i),
            (l = T()),
            (u = l + $),
            l > h || n
              ? (f = h - q.horizontalGutter)
              : h + a > u && (f = h - $ + a + q.horizontalGutter),
            isNaN(f) || _(f, i);
        }
        function T() {
        ...
        function A() {
          G.unbind(je).bind(je, function (e, t, n, i) {
            var r = ie,
              o = ee,
              a = e.deltaFactor || q.mouseWheelSpeed;
            return ke.scrollBy(n * a, -i * a, !1), r == ie && o == ee;
          });
        }
        function P() {
          G.unbind(je);
        ...
        function I() {
          ...
          K && o.push(de[0]),
            ...
            i
              ...
              .bind("keydown.jsp", function (i) {
                if (
                  i.target === this ||
                  (o.length && e(i.target).closest(o).length)
                ) {
                  var a = ie,
                    s = ee;
                  switch (i.keyCode) {
                  ...
                  return (r = (i.keyCode == n && a != ie) || s != ee), !r;
                }
              })
            ...
            q.hideFocus
              ? (i.css("outline", "none"),
                "hideFocus" in G[0] && i.attr("hideFocus", !0))
              : (i.css("outline", ""),
                "hideFocus" in G[0] && i.attr("hideFocus", !1));
        }
        function O() {
          i.attr("tabindex", "-1")
            .removeAttr("tabindex")
            ...
            t.length &&
              ...
              (0 === G.scrollTop()
                ? (n = setInterval(function () {
                    G.scrollTop() > 0 &&
                      (S(t, !0),
                      e(document).scrollTop(G.position().top),
                      clearInterval(n));
                  }, 50))
                : (S(t, !0), e(document).scrollTop(G.position().top)));
          }
        }
        function R() {
          e(document.body).data("jspHijack") ||
            ...
            e(document.body).delegate("a[href*=#]", "click", function (n) {
              var i,
                ...
                s,
                l,
                c = this.href.substr(0, this.href.indexOf("#")),
                u = location.href;
              if (
                ...
                r.length &&
                  ((o = r.closest(".jspScrollable")),
                  (a = o.data("jsp")),
                  a.scrollToElement(r, !0),
                  o[0].scrollIntoView &&
                    ((s = e(t).scrollTop()),
                    (l = r.offset().top),
                    (s > l || l > s + e(t).height()) && o[0].scrollIntoView()),
                  n.preventDefault());
              }
            }));
        }
            ...
            .bind("touchmove.jsp", function (a) {
              if (o) {
                var s = a.originalEvent.touches[0],
                  ...
                  c = ee;
                return (
                  ke.scrollTo(e + n - s.pageX, t + i - s.pageY),
                  (r =
                    r ||
                    Math.abs(n - s.pageX) > 5 ||
                    Math.abs(i - s.pageY) > 5),
                  l == ie && c == ee
                );
              }
            })
        ...
        "border-box" === i.css("box-sizing")
          ...
          e.extend(ke, {
            ...
            scrollBy: function (e, t, n) {
              ke.scrollByX(e, n), ke.scrollByY(t, n);
            },
      ...
      return (
        (i = e.extend({}, e.fn.jScrollPane.defaults, i)),
        e.each(
  ...
  (function (e) {
    var t = function (n, i) {
      (this.element = n),
        this.element.hasClass("flipTimer") ||
          this.element.addClass("flipTimer"),
        (this.userOptions = i),
        (this.defaultOptions = t.defaults),
        (this.options = e.extend({}, this.defaultOptions, this.userOptions)),
        this.element.find(".seconds").length > 0 &&
          (this.options.seconds = this.element.find(".seconds")[0]),
        this.element.find(".minutes").length > 0 &&
          (this.options.minutes = this.element.find(".minutes")[0]),
        this.element.find(".hours").length > 0 &&
          (this.options.hours = this.element.find(".hours")[0]),
        (this.initDate = new Date()),
        (this.options.date = new Date(this.options.date)),
        this.calculateDateByTime(
          this.options.h,
          this.options.m,
          this.options.s
        );
    ...
    (t.defaults = {
      ...
      callback: null,
      digitTemplate:
        '<div class="digit">  <div class="digit-top">    <span class="digit-wrap"></span>  </div>  <div class="shadow-top"></div>  <div class="digit-bottom">    <span class="digit-wrap"></span>  </div>  <div class="shadow-bottom"></div></div>',
    }),
      (t.prototype = {
        ...
        calculateDate: function () {
          ...
          "down" == this.options.direction
            ? (e = this.options.date - this.initDate)
            : "up" == this.options.direction &&
              (e = this.initDate - this.options.date),
        ...
        renderDigits: function (t, n) {
          var i,
            ...
            l,
            c = this;
          0 == e(t).find(".digit").length &&
            ((l =
              c.days < 0 && c.hours < 0 && c.minutes < 0 && c.seconds < 0
                ? [0, 0]
                : c.days > 99
                ? [0, 0]
                : String((n / 10).toFixed(1)).split(".")),
            (a =
              t == c.options.seconds || t == c.options.minutes
                ? 5
                : t == c.options.hours
                ? 2
                : 9),
            e(t).append(
              '<div class="digit-set"></div><div class="digit-set"></div>'
            ),
            e(t)
              .find(".digit-set")
              .each(function (t) {
                for (o = 0 == t ? a : 9, i = 0; i <= o; i++)
                  e(this).append(c.options.digitTemplate),
                    ...
                    r == l[t]
                      ? e(s).addClass("active")
                      : 0 != l[t] && r + 1 == l[t]
                      ? e(s).addClass("previous")
                      : 0 == l[t] && r == o && e(s).addClass("previous");
              }));
        },
        startTimer: function () {
          var e = this;
              ...
              return e.days <= 0 &&
                ...
                : e.days > 99 ||
                  (99 == e.days &&
                    ...
                    59 == e.seconds)
                ? void clearInterval(e.timer)
                : ("down" == e.options.direction ? e.seconds-- : e.seconds++,
                  e.options.seconds && e.increaseDigit(e.options.seconds),
                  (60 != e.seconds && e.seconds != -1) ||
                    ("down" == e.options.direction
                      ? ((e.seconds = 59), e.minutes--)
                      : ((e.seconds = 0), e.minutes++),
                    e.options.minutes && e.increaseDigit(e.options.minutes)),
                  (60 != e.minutes && e.minutes != -1) ||
                    ("down" == e.options.direction
                      ? ((e.minutes = 59), e.hours--)
                      : ((e.minutes = 0), e.hours++),
                    e.options.hours && e.increaseDigit(e.options.hours)),
                  void (
                    (24 != e.hours && e.hours != -1) ||
                    ("down" == e.options.direction
                      ? ((e.hours = 23), e.days--)
                      : ((e.hours = 0), e.days++),
                    e.options.days && e.increaseDigit(e.options.days))
                  ));
            }, 1e3));
        },
        ...
        increaseDigit: function (t) {
          function n(o) {
            ...
            s.removeClass("previous"),
              a.removeClass("active").addClass("previous"),
              0 == a.next().length
                ? ("down" != r.options.direction ||
                  t != r.options.hours ||
                  (r.hours != -1 && 23 != r.hours) ||
                  10 != e(o).find(".digit").length
                    ? e(o).find(".digit:first-child").addClass("active")
                    : e(e(o).find(".digit")[6]).addClass("active"),
                  0 != l && n(i[l - 1]))
      ...
      (e.fn.flipTimer = function (n) {
        return this.each(function () {
          e(this).data("flipTimer") ||
            e(this).data("flipTimer", new t(e(this), n));
        });
      });
  })(jQuery),
  (function (e) {
    ...
    var a = /\+/g,
      s = (e.cookie = function (r, a, l) {
        if (arguments.length > 1 && !e.isFunction(a)) {
          if (
            ((l = e.extend({}, s.defaults, l)), "number" == typeof l.expires)
          ) {
            var c = l.expires,
