...
!
    function (e) {
        ...
        var o = n(257),
            ...
            c = n(177),
            l = r(c);
        (0, s.render)(u.default.createElement(l.default, null), document.getElementById("footer")),
            $(function () {
            ...
            !1;*/
                        ...
                        u.flag = "login",
                            ...
                            $.ajax({
                                ...
                                Number(e.status) == 0 && "" != e.info ? alert(e.info) : window.location.href = e.url
                                //     swal({
                                //             title: "糟糕",
                                //             text: e.info,
                                //             type: "error",
        ...
        function (e, t, n) {
            ...
            function s(e, t) {
                var n = [];
                return p.default.Children.forEach(e,
                    function (e) {
        ...
        function (e, t, n) {
            ...
            function l(e, t) {
                ...
                for (var n = a(e), r = n.tokens, o = 0, i = "", u = 0, s = void 0, c = void 0, l = void 0, f = 0, h = r.length; f < h; ++f) s = r[f],
                    "*" === s || "**" === s ? (l = Array.isArray(t.splat) ? t.splat[u++] : t.splat, null != l || o > 0 ? void 0 : (0, p.default)(!1), null != l && (i += encodeURI(l))) : "(" === s ? o += 1 : ")" === s ? o -= 1 : ":" === s.charAt(0) ? (c = s.substring(1), l = t[c], null != l || o > 0 ? void 0 : (0, p.default)(!1), null != l && (i += encodeURIComponent(l))) : i += s;
                return i.replace(/\/+/g, "/")
            }
                    ...
                    "function" != typeof E && (E = v),
                        a({},
                            b, {
                                ...
                                replaceState: h.default(m, "replaceState is deprecated; use replace instead")
                            })
                }
            }
            ...
            function i(e, t) {
                function n(t) {
                    ...
                    return n && n !== !0 || null !== r ? (t = {
                        ...
                        (0, p.default)(t, o, _.location, _.routes, _.params)
                }

                function r(e, n) {
                    b && b.location === e ? i(b, n) : (0, y.default)(t, e,
                        function (t, r) {
                            t ? n(t) : r ? i(a({},
                                r, {
                                    location: e
                ...
                function i(e, t) {
                    function n(n, o) {
                        return n || o ? r(n, o) : void (0, d.default)(e,
                            function (n, r) {
        ...
        function (e, t, n) {
            ...
            function o(e) {
                function t(e) {
                    return s.canUseDOM ? void 0 : u.default(!1),
                        n.listen(e)
                }
        ...
        function (e, t, n) {
            ...
            function c() {
                ...
                var O = T.queryKey;
                (void 0 === O || O) && (O = "string" == typeof O ? O : w);
                var k = b.default(l({},
                    T, {
        ...
        function (e, t, n) {
            ...
            function a() {
                        ...
                        function (t) {
                            if (W === e) if (t) {
                                if (e.action === h.PUSH) {
                                    var r = E(H),
                                        o = E(e);
                                    o === r && l.default(H.state, e.state) && (e.action = h.REPLACE)
                                }
                                I(e) !== !1 && n(e)
                ...
                return {
                    ...
                    registerTransitionHook: _.default(O, "registerTransitionHook is deprecated; use listenBefore instead"),
                    ...
                    pushState: _.default(R, "pushState is deprecated; use push instead"),
            ...
            var c = Object.assign ||
                ...
                E = f.default.createClass({
                    ...
                    handleClick: function (e) {
                        if (this.props.onClick && this.props.onClick(e), !e.defaultPrevented && (this.context.router ? void 0 : (0, d.default)(!1), !a(e) && i(e) && !this.props.target)) {
                            e.preventDefault();
                            var t = this.props,
                                n = t.to,
                                r = t.query,
                    ...
                    render: function () {
                        ...
                        if (d) {
                            if (null == t) return f.default.createElement("a", h);
                            var v = s(t, {
                                query: n,
                                hash: r,
                                state: i
                        ...
                        return f.default.createElement("a", c({},
                            h, {
                    ...
                    i.prototype.pipe = function (e, n) {
                        ...
                        function u(t) {
                            U("ondata"),
                                _ = !1;
                            var n = e.write(t);
                            !1 !== n || _ || ((1 === h.pipesCount && h.pipes === e || h.pipesCount > 1 && k(h.pipes, e) !== -1) && !m && (U("false write response, pause", p._readableState.awaitDrain), p._readableState.awaitDrain++, _ = !0), p.pause())
                        }
                        ...
                        (0, c.default)(t, [
                            {
                                ...
                                value: function () {
                                    var e = this.state.urls.map(function (e, t) {
                                            return 0 === t ? v.default.createElement("a", {
                                                    key: t,
                                                    className: "item",
                                                    href: e.url,
                                                    target: "_blank"
                                                },
                                                e.name) : v.default.createElement("a", {
                                                    key: t,
                                                    className: "item",
                                                    href: e.url
                                                },
                                    ...
                                    return v.default.createElement("footer", {
            ...
            !
                function (e, t) {
                    var n = window.os = {},
                        ...
                        S = x || e.match(/Version\/([\d.]+)([^S](Safari)|[^M]*(Mobile)[^S]*(Safari))/);
            ...
            var u = Object.assign ||
                ...
                O = v.default.createClass({
                    ...
                    getDefaultProps: function () {
                        return {
                            render: function (e) {
                                return v.default.createElement(b.default, e)
                            }
                        }
                    },
                    ...
                    createRouterObjects: function () {
                        ...
                        var t = this.props.history,
                            ...
                            r = n.routes,
                            o = n.children;
                        a(t) ? (0, h.default)(!1) : void 0,
                        i(t) && (t = this.wrapDeprecatedHistory(t));
                        var u = (0, g.default)(t, (0, w.createRoutes)(r || o)),
            ...
            t.default = function () {
                ...
                return function (e) {
                    return r.reduceRight(function (t, n) {
                        ...
                        a.default.createElement(s.default, o({},
                            e, {
        ...
        function (e, t, n) {
            ...
            var o = n(252),
                ...
                a = n(166),
                u = r(a);
            t.default = (0, u.default)(i.default),
                e.exports = t.default
        },
        function (e, t, n) {
            "use strict";
                    ...
                    for (var i in t) if (t.hasOwnProperty(i) && i !== m) {
                        ...
                        if (o(u, i), w.hasOwnProperty(i)) w[i](e, a);
                            ...
                            if (h) r.push(i, a),
                                ...
                                var d = b[i];
                                !l || "DEFINE_MANY_MERGED" !== d && "DEFINE_MANY" !== d ? p("77", d, i) : void 0,
